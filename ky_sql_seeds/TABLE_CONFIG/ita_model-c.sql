...
CONTENTS_FILE_VARS_NAME           %VARCHR%(256)                    , -- 変数名
...
COLLECT_LOG                       %VARCHR%(1024)                   , -- 収集ログ(テキスト形式)
...
SELECT
  TAB_A.*                       ,
  TAB_B.ROLE_ID                 ,
  [%CONCAT_HEAD/%]TAB_A.ROLE_PACKAGE_ID[%CONCAT_MID/%]':'[%CONCAT_MID/%]TAB_A.ROLE_PACKAGE_NAME[%CONCAT_MID/%]':'[%CONCAT_MID/%]TAB_B.ROLE_ID[%CONCAT_MID/%]':'[%CONCAT_MID/%]TAB_B.ROLE_NAME[%CONCAT_TAIL/%] ROLE_PACKAGE_PULLDOWN
FROM
...
ELECT
  TAB_A.*                       ,
  TAB_B.ROLE_ID                 ,
  [%CONCAT_HEAD/%]TAB_A.ROLE_PACKAGE_ID[%CONCAT_MID/%]':'[%CONCAT_MID/%]TAB_A.ROLE_PACKAGE_NAME[%CONCAT_MID/%]':'[%CONCAT_MID/%]TAB
_A.ROLE_ID[%CONCAT_MID/%]':'[%CONCAT_MID/%]TAB_B.ROLE_NAME[%CONCAT_TAIL/%] ROLE_PACKAGE_PULLDOWN
FROM
