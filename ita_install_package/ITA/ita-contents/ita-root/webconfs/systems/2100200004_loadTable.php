...
$tmpFx = function (&$aryVariant=array(),&$arySetting=array()){
    ...
    $arrayWebSetting['page_info'] = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-104010");
/*
...
*/
    ...
    $table = new TableControlAgent('B_TERRAFORM_CLI_MODULE','MODULE_MATTER_ID', $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-104020"), 'B_TERRAFORM_CLI_MODULE_JNL', $tmpAry);
    $tmpAryColumn = $table->getColumns();
    $tmpAryColumn['MODULE_MATTER_ID']->setSequenceID('B_TERRAFORM_CLI_MODULE_RIC');
    $tmpAryColumn['JOURNAL_SEQ_NO']->setSequenceID('B_TERRAFORM_CLI_MODULE_JSQ');
    unset($tmpAryColumn);

    // QMファイル名プレフィックス
    $table->setDBMainTableLabel($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-104030"));
    // エクセルのシート名
    $table->getFormatter('excel')->setGeneValue('sheetNameForEditByFile', $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-104040"));
    ...
    $c = new TextColumn('MODULE_MATTER_NAME',$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-104050"));
    $c->setDescription($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-104060"));//エクセル・ヘッダでの説明
    ...
    //----Module素材
    //************************************************************************************
    $c = new FileUploadColumn('MODULE_MATTER_FILE',$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-104070"));
    $c->setDescription($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-104080"));//エクセル・ヘッダでの説明
    ...
    $strLabelText = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-104090");
