...
*/
    ...
    //リンクボタン
    $c = new LinkButtonColumn('RESULT_DOWNLOAD',$g['objMTS']->getSomeMessage("ITABASEH-MNU-309029"), $g['objMTS']->getSomeMessage("ITABASEH-MNU-309031"), 'out_dl', array(':SYMPHONY_INSTANCE_NO')); 
    $table->addColumn($c);
