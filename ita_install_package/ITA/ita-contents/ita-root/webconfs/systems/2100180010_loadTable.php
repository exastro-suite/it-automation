...
$tmpFx = function (&$aryVariant=array(),&$arySetting=array()){
    ...
    $arrayWebSetting['page_info'] = $g['objMTS']->getSomeMessage("ITABASEH-MNU-308300");
/*
...
*/
    ...
    $table = new TableControlAgent('C_NODE_INSTANCE_MNG','NODE_INSTANCE_NO', $g['objMTS']->getSomeMessage("ITABASEH-MNU-308301"), 'C_NODE_INSTANCE_MNG_JNL', $tmpAry);
    ...
    // QMファイル名プレフィックス
    $table->setDBMainTableLabel($g['objMTS']->getSomeMessage("ITABASEH-MNU-308302"));
    // エクセルのシート名
    $table->getFormatter('excel')->setGeneValue('sheetNameForEditByFile',$g['objMTS']->getSomeMessage("ITABASEH-MNU-308302"));

    $table->setAccessAuth(true);    // データごとのRBAC設定


    $c = new NumColumn('I_NODE_CLASS_NO', $g['objMTS']->getSomeMessage("ITABASEH-MNU-308303"));
    $c->setDescription($g['objMTS']->getSomeMessage("ITABASEH-MNU-308303"));//エクセル・ヘッダでの説明
    ...
    $c = new NumColumn('CONDUCTOR_INSTANCE_NO', $g['objMTS']->getSomeMessage("ITABASEH-MNU-209114"));
