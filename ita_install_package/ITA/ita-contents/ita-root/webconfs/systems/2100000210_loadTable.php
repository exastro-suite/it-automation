...
$tmpFx = function (&$aryVariant=array(),&$arySetting=array()){
    ...
    $cg = new ColumnGroup($g['objMTS']->getSomeMessage("ITAWDCH-MNU-1090701"));
	    ...
	    $c = new LinkIDColumn('ROLE_ID_CLONE', $g['objMTS']->getSomeMessage("ITAWDCH-MNU-1090201"), "D_ROLE_LIST", 'ROLE_ID', "ROLE_ID", $arrUrl, '', array('OrderByThirdColumn'=>'ROLE_ID'));
    ...
    //----チケット953
		...
		$arrUrl[1] = "&Filter1Tbl_1__E=";
    $c = new LinkIDColumn('USER_ID_CLONE', $g['objMTS']->getSomeMessage("ITAWDCH-MNU-1090401"), "D_ACCOUNT_LIST", 'USER_ID', 'USER_ID', $arrUrl, '', array('OrderByThirdColumn'=>'USER_ID'));
    $c->addClass("number");
