...
$tmpFx = function (&$aryVariant=array(),&$arySetting=array()){
    ...
    $cg = new ColumnGroup($g['objMTS']->getSomeMessage("ITAWDCH-MNU-1081101"));
      ...
      $arrUrl[1] = "&Filter1Tbl_1__E=";
	    $c = new LinkIDColumn('ROLE_ID_CLONE', $g['objMTS']->getSomeMessage("ITAWDCH-MNU-1080201"), "D_ROLE_LIST", 'ROLE_ID', "ROLE_ID", $arrUrl, '', array('OrderByThirdColumn'=>'ROLE_ID'));
    ...
    $arrUrl[1] = "&Filter1Tbl_1__E=";
    $c = new LinkIDColumn('MENU_GROUP_ID', $g['objMTS']->getSomeMessage("ITAWDCH-MNU-1080901"), 'A_MENU_GROUP_LIST', 'MENU_GROUP_ID', 'MENU_GROUP_ID', $arrUrl, '', array('OrderByThirdColumn'=>'MENU_GROUP_ID'));
    $c->addClass("number");
    ...
    $arrUrl[1] = "&Filter1Tbl_1__E=";
    $c = new LinkIDColumn('MENU_ID_CLONE', $g['objMTS']->getSomeMessage("ITAWDCH-MNU-1080401"), "A_MENU_LIST", 'MENU_ID', "MENU_ID", $arrUrl, '', array('OrderByThirdColumn'=>'MENU_ID'));
    $c->addClass("number");
