...
$tmpFx = function (&$aryVariant=array(),&$arySetting=array()){
    ...
    $arrayWebSetting['page_info'] = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108010");
/*
Terraform代入値管理
*/
    $tmpAry = array(
    ...
    $table = new TableControlAgent('D_TERRAFORM_CLI_VARS_ASSIGN','ASSIGN_ID',$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108020"), 'D_TERRAFORM_CLI_VARS_ASSIGN_JNL', $tmpAry);
    $tmpAryColumn = $table->getColumns();
    $tmpAryColumn['ASSIGN_ID']->setSequenceID('B_TERRAFORM_CLI_VARS_ASSIGN_RIC');
    $tmpAryColumn['JOURNAL_SEQ_NO']->setSequenceID('B_TERRAFORM_CLI_VARS_ASSIGN_JSQ');
    unset($tmpAryColumn);

    // ----VIEWをコンテンツソースにする場合、構成する実体テーブルを更新するための設定
    $table->setDBMainTableHiddenID('B_TERRAFORM_CLI_VARS_ASSIGN');
    $table->setDBJournalTableHiddenID('B_TERRAFORM_CLI_VARS_ASSIGN_JNL');
    ...
    // QMファイル名プレフィックス
    $table->setDBMainTableLabel($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108030"));
    // エクセルのシート名
    $table->getFormatter('excel')->setGeneValue('sheetNameForEditByFile',$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108040"));
    ...
    //************************************************************************************
    //----オペレーション
    $c = new IDColumn('OPERATION_NO_UAPK',$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108050"),'E_OPERATION_LIST','OPERATION_NO_UAPK','OPERATION','E_OPE_FOR_PULLDOWN_TERRAFORM',array('OrderByThirdColumn'=>'OPERATION_NO_UAPK'));
    $c->setDescription($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108060"));//エクセル・ヘッダでの説明
    ...
    $c = new IDColumn('REST_MODULE_VARS_LINK_ID',$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108070"),'E_TERRAFORM_CLI_PTN_VAR_LIST','MODULE_PTN_LINK_ID','PTN_VAR_PULLDOWN','',array('OrderByThirdColumn'=>'MODULE_PTN_LINK_ID'));
    $c->setDescription($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108080"));
    ...
    $c = new IDColumn('PATTERN_ID',$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108090"),'E_TERRAFORM_CLI_PATTERN','PATTERN_ID','PATTERN','',array('OrderByThirdColumn'=>'PATTERN_ID'));
    $c->setDescription($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108100"));//エクセル・ヘッダでの説明
    ...
    $c = new IDColumn('MODULE_VARS_LINK_ID',$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108110"),'D_TERRAFORM_CLI_PTN_VARS_LINK','MODULE_VARS_LINK_ID','VARS_LINK_PULLDOWN','D_TERRAFORM_CLI_PTN_VARS_LINK_VFP');
    $c->setDescription($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108120"));//エクセル・ヘッダでの説明

    $strSetInnerText = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108130");
    ...
    //----変数名(Webページ表示用)
    $c = new IDColumn('VARS_PTN_LINK_ID',$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108110"),'D_TERRAFORM_CLI_PTN_VAR_LIST','MODULE_PTN_LINK_ID','VARS_LINK_PULLDOWN','',array('OrderByThirdColumn'=>'MODULE_PTN_LINK_ID'));
    $c->setDescription($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108120"));//エクセル・ヘッダでの説明
    ...
    //----HCL設定
    //************************************************************************************
    $c = new IDColumn('HCL_FLAG',$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108180"), 'B_TERRAFORM_CLI_HCL_FLAG', 'HCL_FLAG', 'HCL_FLAG_SELECT', '', array('SELECT_ADD_FOR_ORDER'=>array('HCL_FLAG'), 'ORDER'=>'ORDER BY ADD_SELECT_1'));
    $c->setDescription($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108190")); //エクセル・ヘッダでの説明
    ...
    $objFunction04 = function($objCellFormatter, $arraySelectElement,$data,$boolWhiteKeyAdd,$varAddResultData,&$aryVariant,&$arySetting,&$aryOverride){
        ...
        //入力不要
        $strMsgBody01 = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108220");
        $strMsgBody02 = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108230");
        $strMsgBody03 = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108240");
    ...
    $objFunction05 = function($objCellFormatter, $arraySelectElement,$data,$boolWhiteKeyAdd,$rowData,$aryVariant){
        ...
        //入力不要
        $strMsgBody01 = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108250");
        $strMsgBody03 = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108260");
    ...
    //----メンバー変数名
    $c = new IDColumn('MEMBER_VARS',$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108200"),'D_TERRAFORM_CLI_VAR_MEMBER','CHILD_MEMBER_VARS_ID','CHILD_MEMBER_VARS_NEST');
    $c->setDescription($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108210"));//エクセル・ヘッダでの説明
    //コンテンツのソースがヴューの場合、登録/更新の対象とする
    $c->setHiddenMainTableColumn(true);


    $strSetInnerText = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108270");
    $objVarBFmtUpd = new SelectTabBFmt();
    ...
    $c = new IDColumn('REST_MEMBER_VARS',$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108200"),'E_TERRAFORM_CLI_VAR_MEMBER_LIST','CHILD_MEMBER_VARS_ID','VAR_MEMBER_PULLDOWN','',array('OrderByThirdColumn'=>'CHILD_MEMBER_VARS_ID'));
    $c->setDescription($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108210"));
    ...
    $objFunction01 = function($strTagInnerBody,$objCellFormatter,$rowData,$aryVariant,$aryAddOnDefault,$aryOverWrite){
        ...
        //メッセージ
        $strMsgBody01 = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108280");
        $strMsgBody02 = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108290");
        $strMsgBody03 = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108300");
    ...
    $objFunction02 = function($strTagInnerBody,$objCellFormatter,$rowData,$aryVariant,$aryAddOnDefault,$aryOverWrite){
        ...
        //メッセージ
        $strMsgBody01 = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108310");
        $strMsgBody02 = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108320");
        $strMsgBody03 = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108330");
    ...
    //----代入順序
    $c = new NumColumn('ASSIGN_SEQ',$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108340"));
    $c->setDescription($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108350"));//エクセル・ヘッダでの説明
    $c->setOutputType('update_table',$objOTForUpd);
    $c->setOutputType('register_table',$objOTForReg);
    ...
    //----デフォルト値
    //************************************************************************************
    $c = new Column('DEFAULT_VALUE',$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108360"));
    $c->setDescription($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108370"));//エクセル・ヘッダでの説明
    $c->setDBColumn(false);
    $c->getOutputType('filter_table')->setVisible(false);
    $c->getOutputType('print_table')->setVisible(false);
    ...
    //----Sensitive設定
    //************************************************************************************
    $c = new IDColumn('SENSITIVE_FLAG',$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108160"), 'B_SENSITIVE_FLAG', 'VARS_SENSITIVE', 'VARS_SENSITIVE_SELECT', '', array('SELECT_ADD_FOR_ORDER'=>array('VARS_SENSITIVE'), 'ORDER'=>'ORDER BY ADD_SELECT_1'));
    $c->setDescription($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108170")); //エクセル・ヘッダでの説明
    ...
    $c = new SensitiveMultiTextColumn('VARS_ENTRY',$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108140"), 'SENSITIVE_FLAG');
    $c->setDescription($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-108150"));//エクセル・ヘッダでの説明
...
//tail of setting [multi-set-unique]----
    ...
    $objFunction = function($objClientValidator, $value, $strNumberForRI, $arrayRegData, $arrayVariant){
        ...
        $pattan_tbl         = "E_TERRAFORM_CLI_PATTERN";      // モード毎
            ...
            if((strlen($intPatternId)          === 0) &&
               ...
               (strlen($intRestVarsLinkId)     !== 0)){
                ...
                $query =  "SELECT                                             "
                         ...
                         ."FROM                                               "
                         ."  E_TERRAFORM_CLI_PTN_VAR_LIST TBL_A                     "      //モード毎
                         ."WHERE                                              "
                ...
                if( $retArray[0] === true ){
                    ...
                    if( $row['MODULE_VARS_LINK_ID_CNT'] == '1' ){
                        ...
                        $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203010");
                        $retBool = false;
                        $boolExecuteContinue = false;
                    }else{
        ...
        if( $boolExecuteContinue === true && $boolSystemErrorFlag === false){
            if( strlen($intPatternId) === 0 ){
                $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203020");
                $boolExecuteContinue = false;
                $retBool = false;
            }
            else if( strlen($intVarsLinkId) === 0 ){
                $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203030");
                $boolExecuteContinue = false;
                $retBool = false;
            }
        }
        ...
        if( $boolExecuteContinue === true && $boolSystemErrorFlag === false){
            ...
            if( $retArray[0] === true ){
                ...
                if( $row['PATTAN_CNT'] == '1' ){
                    ...
                    $boolExecuteContinue = false;
                    $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203040");
                }else{
                    web_log("DB Access error file:" . basename(__FILE__) . " line:" . __LINE__);
                    $boolSystemErrorFlag = true;
                }
        ...
        if( $boolExecuteContinue === true ){
            ...
            if( $retArray[0] === true ){
                ...
                if( $row['REC_COUNT'] == '1' ){
                    ...
                    $boolExecuteContinue = false;
                    $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203050");
                }else{
                    web_log("DB Access error file:" . basename(__FILE__) . " line:" . __LINE__);
                    $boolSystemErrorFlag = true;
                }
        ...
        if( $boolExecuteContinue === true ){
            if($intHclId == 1){
                ...
                if(0 < strlen($intMemberVarsId) || 0 < strlen($intAssignSeqId)){
                    $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203070");
                    $boolExecuteContinue = false;
                    $retBool = false;
                }
            }else{
        ...
        if( $boolExecuteContinue === true ){
            ...
            if( $retArray[0] === true ){
                ...
                if(($intHclId == 1 && in_array(2, $hcltypearray)) || ($intHclId == 2 && in_array(1, $hcltypearray))){
                    $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203080");
                    $boolExecuteContinue = false;
                    $retBool = false;
                }
                ...
                if($intSensitiveId == 1 && in_array(2,$sensitivetypearray) || $intSensitiveId == 2 && in_array(1,$sensitivetypearray)){
                    $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203110");
                    $boolExecuteContinue = false;
                    $retBool = false;
                }
            }else{
        ...
        if( $boolExecuteContinue === true && $intHclId == 1){
            ...
            if( $retArray[0] === true ){
                ...
                if(0 < strlen($typeId)){
                    ...
                    if( $retArray[0] === true ){
                        ...
                        if($member_vars_flg == 0 && $assign_seq_flg == 0){
                            if(!strlen($intMemberVarsId) && !strlen($intAssignSeqId)){
                                ...
                                $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203120");
                            }

                            if($typeId == 7 && $intHclId == 1){
                                $retBool = false;
                                $boolExecuteContinue = false;
                                $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203220");
                            }
                            ...
                            if(0 < strlen($intMemberVarsId)){
                                ...
                                $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203130");
                            }elseif(1 >strlen($intMemberVarsId)){
                                $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203140");
                            }
                            ...
                            if( 0 < strlen($intAssignSeqId) && !strlen($intMemberVarsId)){
                                ...
                                $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203150");
                            }elseif(0 < strlen($intMemberVarsId)){
                                $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203160");
                            }
                            ...
                            if( strlen($intMemberVarsId)){
                                ...
                                $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203210");
                            }
                        }
                    }else{
                        web_log("DB Access error file:" . basename(__FILE__) . " line:" . __LINE__);
                    ...
                    $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203170");
                    $retBool = false;
                    $boolExecuteContinue = false;
                }else{
                    web_log("DB Access error file:" . basename(__FILE__) . " line:" . __LINE__);
            ...
            if( 0 < strlen($intMemberVarsId)){
                ...
                if( $retArray[0] === true ){
                    ...
                    if( $row['REC_COUNT'] == '1' ){
                        ...
                        $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203060");
                        $retBool = false;
                        $boolExecuteContinue = false;
                    }else{
                        web_log("DB Access error file:" . basename(__FILE__) . " line:" . __LINE__);
        ...
        if( $boolExecuteContinue === true ){
            if( 0 < strlen($intMemberVarsId)){
                ...
                if( $retArray[0] === true ){
                        ...
                        if( $retArray[0] === true ){
                            ...
                            if($type_Flg == 0 && 1 > strlen($intAssignSeqId)){
                                ...
                                if( 0 < strlen($intAssignSeqId)){
                                    ...
                                    $retBool = false;
                                    $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203180");
                                }
                            }elseif($type_Flg == 0 && 0 < strlen($intAssignSeqId)){
                                $retBool = false;
                                $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203190");
                            }else{
                                web_log("DB Access error file:" . basename(__FILE__) . " line:" . __LINE__);
                                $boolSystemErrorFlag = true;
                            }
                    ...
                    $retBool = false;
                    $retStrBody = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-203200");
                }else{
                    web_log("DB Access error file:" . basename(__FILE__) . " line:" . __LINE__);
                    $boolSystemErrorFlag = true;
