...
$tmpFx = function (&$aryVariant=array(),&$arySetting=array()){
    ...
    $arrayWebSetting['page_info'] = $g['objMTS']->getSomeMessage("ITATERRAFORM-MNU-103510");
/*
Terraform作業パターン詳細
*/
    $tmpAry = array(
    ...
    $table = new TableControlAgent('B_TERRAFORM_PATTERN_LINK','LINK_ID',$g['objMTS']->getSomeMessage("ITATERRAFORM-MNU-103520"), 'B_TERRAFORM_PATTERN_LINK_JNL', $tmpAry);
    $tmpAryColumn = $table->getColumns();
    $tmpAryColumn['LINK_ID']->setSequenceID('B_TERRAFORM_PATTERN_LINK_RIC');
    $tmpAryColumn['JOURNAL_SEQ_NO']->setSequenceID('B_TERRAFORM_PATTERN_LINK_JSQ');
    unset($tmpAryColumn);

    // QMファイル名プレフィックス
    $table->setDBMainTableLabel($g['objMTS']->getSomeMessage("ITATERRAFORM-MNU-103530"));
    // エクセルのシート名
