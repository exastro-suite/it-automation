...
$tmpFx = function (&$aryVariant=array(),&$arySetting=array()){
    ...
    $arrayWebSetting['page_info'] = $g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101501");
    ...
    $table = new TableControlAgent('G_FILE_MANAGEMENT_2','FILE_M_ID', $g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101301"), 'G_FILE_MANAGEMENT_JNL', $tmpAry);
    ...
    $tmpAryColumn['ROW_EDIT_BY_FILE']->setResultCount(array('register'=>array('name'=>$g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101353"),'ct'=>0),
    ...
    // QMファイル名プレフィックス
    $table->setDBMainTableLabel($g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101502"));
    // エクセルのシート名
    $table->getFormatter('excel')->setGeneValue('sheetNameForEditByFile', $g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101503"));
    ...
    // ステータス
    //////////////////////////////////////
    $c = new IDColumn('FILE_STATUS_ID',$g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101302"),'F_MM_STATUS_MASTER','FILE_STATUS_ID','FILE_STATUS_NAME','G_FILE_STATUS_MASTER_2',array('OrderByThirdColumn'=>'FILE_STATUS_ID'));
