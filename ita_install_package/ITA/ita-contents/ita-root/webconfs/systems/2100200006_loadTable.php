...
$tmpFx = function (&$aryVariant=array(),&$arySetting=array()){
    ...
    $arrayWebSetting['page_info'] = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-106010");
/*
Terraform-CLI変数ネスト管理
*/
    ...
    $table = new TableControlAgent('B_TERRAFORM_CLI_LRL_MAX_MEMBER_COL', 'MAX_COL_SEQ_ID', $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-106020"), 'B_TERRAFORM_CLI_LRL_MAX_MEMBER_COL_JNL', $tmpAry);
    $tmpAryColumn = $table->getColumns();
    $tmpAryColumn['MAX_COL_SEQ_ID']->setSequenceID('B_TERRAFORM_CLI_LRL_MAX_MEMBER_COL_RIC');
    $tmpAryColumn['JOURNAL_SEQ_NO']->setSequenceID('B_TERRAFORM_CLI_LRL_MAX_MEMBER_COL_JSQ');
    ...
    // QMファイル名プレフィックス
    $table->setDBMainTableLabel($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-106030"));
    // エクセルのシート名
    $table->getFormatter('excel')->setGeneValue('sheetNameForEditByFile',$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-106040"));

    $table->setAccessAuth(true);    // データごとのRBAC設定
	$table->setNoRegisterFlg(true);    // 登録画面無し

    // 変数名
    $c = new IDColumn('VARS_ID', $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-106050"), 'B_TERRAFORM_CLI_MODULE_VARS_LINK', 'MODULE_VARS_LINK_ID', 'VARS_NAME');
    $c->setDescription($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-106060")); //エクセル・ヘッダでの説明
    ...
    // メンバー変数名
    $c = new IDColumn('MEMBER_VARS_ID', $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-106070"), 'D_TERRAFORM_CLI_VAR_MEMBER', 'CHILD_MEMBER_VARS_ID', 'CHILD_MEMBER_VARS_NEST');
    $c->setDescription($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-106080")); //エクセル・ヘッダでの説明
    ...
    // 最大繰り返し数
    $c = new NumColumn('MAX_COL_SEQ', $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-106090"));
    $c->setDescription($g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-106100")); //エクセル・ヘッダでの説明
    //更新対象カラム
    $c->setHiddenMainTableColumn(true);
