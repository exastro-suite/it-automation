...
$tmpFx = function (&$aryVariant=array(),&$arySetting=array()){
    ...
    $arrayWebSetting['page_info'] = $g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101801");
    ...
    $table = new TableControlAgent('G_FILE_MANAGEMENT_5','FILE_M_ID', $g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101301"), 'G_FILE_MANAGEMENT_JNL', $tmpAry);
    ...
    // QMファイル名プレフィックス
    $table->setDBMainTableLabel($g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101802"));
    // エクセルのシート名
    $table->getFormatter('excel')->setGeneValue('sheetNameForEditByFile', $g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101803"));
    ...
    // ステータス
    //////////////////////////////////////
    $c = new IDColumn('FILE_STATUS_ID',$g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101302"),'F_MM_STATUS_MASTER','FILE_STATUS_ID','FILE_STATUS_NAME','G_FILE_STATUS_MASTER_5',array('OrderByThirdColumn'=>'FILE_STATUS_ID'));
    ...
    $cg = new ColumnGroup($g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101304"));
        ...
        // 資材名
        //////////////////////////////////////
        $c = new IDColumn('FILE_NAME_FULLPATH',$g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101305"),'G_FILE_MASTER','FILE_ID','FILE_NAME_FULLPATH','G_FILE_MASTER',array('OrderByThirdColumn'=>'FILE_NAME_FULLPATH'));
        $c->setDescription($g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101306"));//エクセル・ヘッダでの説明
    ...
    $cg = new ColumnGroup($g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101329"));
        ...
        $tmpObjFunction = function($objColumn, $strEventKey, &$exeQueryData, &$reqOrgData=array(), &$aryVariant=array()){
            ...
            if($modeValue=="DTUP_singleRecUpdate" && $exeQueryData['FILE_STATUS_ID'] == "8"){
        ...
        $tmpObjFunction = function($objColumn, $strEventKey, &$exeQueryData, &$reqOrgData=array(), &$aryVariant=array()){
            ...
            $modeValue = $aryVariant["TCA_PRESERVED"]["TCA_ACTION"]["ACTION_MODE"];
            if($modeValue=="DTUP_singleRecUpdate" && $exeQueryData['FILE_STATUS_ID'] == "8"){
                $reqOrgData["del_flag_".$objColumn->getIDSOP()] = "on";
            }
            $retArray = array($boolRet,$intErrorType,$aryErrMsgBody,$strErrMsg,$strErrorBuf);
            return $retArray;
        };
    ...
    $cg = new ColumnGroup($g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101344"));
        ...
        $tmpObjFunction = function($objColumn, $strEventKey, &$exeQueryData, &$reqOrgData=array(), &$aryVariant=array()){
            ...
            // 更新時に設定
            $modeValue = $aryVariant["TCA_PRESERVED"]["TCA_ACTION"]["ACTION_MODE"];
            if($modeValue=="DTUP_singleRecUpdate" && $exeQueryData['FILE_STATUS_ID'] == "5"){
