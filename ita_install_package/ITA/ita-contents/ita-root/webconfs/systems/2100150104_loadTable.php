...
$tmpFx = function (&$aryVariant=array(),&$arySetting=array()){
    ...
    $arrayWebSetting['page_info'] = $g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101701");
    ...
    $table = new TableControlAgent('G_FILE_MANAGEMENT_4','FILE_M_ID', $g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101301"), 'G_FILE_MANAGEMENT_JNL', $tmpAry);
    ...
    // QMファイル名プレフィックス
    $table->setDBMainTableLabel($g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101702"));
    // エクセルのシート名
    $table->getFormatter('excel')->setGeneValue('sheetNameForEditByFile', $g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101703"));
    ...
    // ステータス
    //////////////////////////////////////
    $c = new IDColumn('FILE_STATUS_ID',$g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101302"),'F_MM_STATUS_MASTER','FILE_STATUS_ID','FILE_STATUS_NAME','G_FILE_STATUS_MASTER_4',array('OrderByThirdColumn'=>'FILE_STATUS_ID'));
    ...
    $c->setDBColumn(true);
    $c->getOutputType('update_table')->setOverrideInputValue(4);
    ...
    $cg = new ColumnGroup($g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101304"));
        ...
        // 資材名
        //////////////////////////////////////
        $c = new IDColumn('FILE_NAME_FULLPATH',$g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101305"),'G_FILE_MASTER','FILE_NAME_FULLPATH','FILE_NAME_FULLPATH','G_FILE_MASTER',array('OrderByThirdColumn'=>'FILE_NAME_FULLPATH'));
        $c->setDescription($g['objMTS']->getSomeMessage("ITAMATERIAL-MNU-101306"));//エクセル・ヘッダでの説明
