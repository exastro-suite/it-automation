...
$tmpFx = function (&$aryVariant=array(),&$arySetting=array()){
    ...
    $c = new LinkIDColumn('MENU_GROUP_ID_CLONE', $g['objMTS']->getSomeMessage("ITAWDCH-MNU-1040301"), 'D_MENU_GROUP_LIST', 'MENU_GROUP_ID', 'MENU_GROUP_ID', $arrUrl, '', array('OrderByThirdColumn'=>'MENU_GROUP_ID') );
    $c->addClass("number");
