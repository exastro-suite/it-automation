...
$tmpFx = function (&$aryVariant=array(),&$arySetting=array()){
    ...
    $arrayWebSetting['page_info'] = $g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901000");
/*
Ansible（Legacy）代入値自動登録設定
*/
    $tmpAry = array(
    ...
    $table = new TableControlAgent('D_ANS_LNS_VAL_ASSIGN','COLUMN_ID',$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901001"), 'D_ANS_LNS_VAL_ASSIGN_JNL', $tmpAry);
    $tmpAryColumn = $table->getColumns();
    $tmpAryColumn['COLUMN_ID']->setSequenceID('B_ANS_LNS_VAL_ASSIGN_RIC');
    $tmpAryColumn['JOURNAL_SEQ_NO']->setSequenceID('B_ANS_LNS_VAL_ASSIGN_JSQ');
    unset($tmpAryColumn);

    // ----VIEWをコンテンツソースにする場合、構成する実体テーブルを更新するための設定
    $table->setDBMainTableHiddenID('B_ANS_LNS_VAL_ASSIGN');
    $table->setDBJournalTableHiddenID('B_ANS_LNS_VAL_ASSIGN_JNL');
    ...
    // QMファイル名プレフィックス
    $table->setDBMainTableLabel($g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901002"));
    // エクセルのシート名
    $table->getFormatter('excel')->setGeneValue('sheetNameForEditByFile',$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901003"));
    ...
    ////////////////////////////////////////////////////////////
    $cgg = new ColumnGroup($g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901301"));

        ////////////////////////////////////////////////////////////
        // カラムグループ メニューグループ(一覧のみ表示)
        ////////////////////////////////////////////////////////////
        $cg = new ColumnGroup($g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901004"));

            ////////////////////////////////////////////////////////////
            // メニューグループID
            ////////////////////////////////////////////////////////////
            $c = new IDColumn('MENU_GROUP_ID', $g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901005"), 'A_MENU_GROUP_LIST', 'MENU_GROUP_ID', 'MENU_GROUP_ID', '', array('OrderByThirdColumn'=>'MENU_GROUP_ID'));
            $c->addClass("number");
            $c->setHiddenMainTableColumn(false);
            $c->setAllowSendFromFile(false);
            $c->setDescription($g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901006"));
        ...
        // カラムグループ メニュー(一覧のみ表示)
        ////////////////////////////////////////////////////////////
        $cg = new ColumnGroup($g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901009"));

            ////////////////////////////////////////////////////////////
            // メニューID
            ////////////////////////////////////////////////////////////
            $c = new IDColumn('MENU_ID_CLONE', $g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901010"), "D_MENU_LIST", 'MENU_ID', "MENU_ID", '', array('OrderByThirdColumn'=>'MENU_ID'));
            $c->addClass("number");
        ...
        $c = new IDColumn('MENU_ID',$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901100"),'D_CMDB_MENU_LIST','MENU_ID','MENU_PULLDOWN','',array('OrderByThirdColumn'=>'MENU_ID'));
        $c->setDescription($g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901101"));
        ...
        $c = new IDColumn('COLUMN_LIST_ID',$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901120"),'B_CMDB_MENU_COLUMN','COLUMN_LIST_ID','COL_TITLE','',array('SELECT_ADD_FOR_ORDER'=>array('COL_TITLE_DISP_SEQ'),'ORDER'=>'ORDER BY ADD_SELECT_1') );

        $c->setDescription($g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901121"));
        ...
        $strSetInnerText = $g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901262");
    ...
    //登録方式
    ////////////////////////////////////////////////////////////
    $c = new IDColumn('COL_TYPE',$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901130"),'B_CMDB_MENU_COL_TYPE','COLUMN_TYPE_ID','COLUMN_TYPE_NAME','',array('OrderByThirdColumn'=>'COLUMN_TYPE_ID'));
    $c->setDescription($g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901131"));
    ...
    ////////////////////////////////////////////////////////////
    $cgg = new ColumnGroup($g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901302"));
        ...
        $c = new IDColumn('PATTERN_ID',$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901140"),'E_ANSIBLE_LNS_PATTERN','PATTERN_ID','PATTERN','',array('OrderByThirdColumn'=>'PATTERN_ID'));
        $c->setDescription($g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901141"));
        ...
        //////////////////////////////////////////////////
        $cg = new ColumnGroup($g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901210"));
            ...
            $c = new IDColumn('KEY_VARS_LINK_ID',$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901220"),'D_ANS_LNS_PTN_VARS_LINK','VARS_LINK_ID','VARS_LINK_PULLDOWN','D_ANS_LNS_PTN_VARS_LINK_VFP');

            $c->setDescription($g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901221"));//エクセル・ヘッダでの説明
            ...
            $strSetInnerText = $g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901222");
            $objVarBFmtUpd = new SelectTabBFmt();
            ...
            ////////////////////////////////////////////////////////
            // REST/excel/csv入力用 Key変数　Movement+変数名
            $c = new IDColumn('REST_KEY_VARS_LINK_ID',$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-502065"),'E_ANS_LNS_PTN_VAR_LIST','VARS_LINK_ID','PTN_VAR_PULLDOWN','',array('OrderByThirdColumn'=>'VARS_LINK_ID'));
            ...
            // 代入順序
            //////////////////////////////////////////////////
            $c = new NumColumn('KEY_ASSIGN_SEQ',$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901260"));
            $c->setDescription($g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901261"));
        ...
        //////////////////////////////////////////////////
        $cg = new ColumnGroup($g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901150"));
            ...
            $c = new IDColumn('VAL_VARS_LINK_ID',$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901160"),'D_ANS_LNS_PTN_VARS_LINK','VARS_LINK_ID','VARS_LINK_PULLDOWN','D_ANS_LNS_PTN_VARS_LINK_VFP');
            $c->setDescription($g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901161"));
            ...
            $strSetInnerText = $g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901162");
            $objVarBFmtUpd = new SelectTabBFmt();
            ...
            $c = new IDColumn('REST_VAL_VARS_LINK_ID',$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-502066"),'E_ANS_LNS_PTN_VAR_LIST','VARS_LINK_ID','PTN_VAR_PULLDOWN','',array('OrderByThirdColumn'=>'VARS_LINK_ID'));
            $c->setDescription($g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-503030"));
            $c->setJournalTableOfMaster('E_ANS_LNS_PTN_VAR_LIST_JNL');
            $c->setJournalSeqIDOfMaster('JOURNAL_SEQ_NO');
            $c->setJournalLUTSIDOfMaster('LAST_UPDATE_TIMESTAMP');
            ...
            // 代入順序
            //////////////////////////////////////
            $c = new NumColumn('VAL_ASSIGN_SEQ',$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901200"));
            $c->setDescription($g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1901201"));
    ...
    $objFunction = function($objClientValidator, $value, $strNumberForRI, $arrayRegData, $arrayVariant){
        ...
        // --UPD--
        $pattan_tbl         = "E_ANSIBLE_LNS_PATTERN";
        $ptn_vars_link_view = "D_ANS_LNS_PTN_VARS_LINK_VFP";
