...
class AnsibleTowerRestApiExecutionEnvironment extends AnsibleTowerRestApiBase {

    const API_PATH  = "execution_environments/";

    // static only
    private function __construct() {
    }

    static function get($RestApiCaller) {

        // REST APIアクセス
        $method = "GET";
        $response_array = $RestApiCaller->restCall($method, self::API_PATH);
