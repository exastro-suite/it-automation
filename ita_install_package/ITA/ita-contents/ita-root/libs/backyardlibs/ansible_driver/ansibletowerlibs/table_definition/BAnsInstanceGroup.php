...
class BAnsInstanceGroup extends TableBaseDefinition {

    public static function getTableName() {
        return "B_ANS_TWR_INSTANCE_GROUP"; 
    }

    protected static $specificColumns = array(
            "INSTANCE_GROUP_ITA_MANAGED_ID" => "", 
            "INSTANCE_GROUP_ID"             => "", 
            "INSTANCE_GROUP_NAME"           => "", 
        );
    ...
    public static function getPKColumnName() {
        return "INSTANCE_GROUP_ITA_MANAGED_ID";
    }
