...
//
    ...
    // Pioneerの場合の各定数定義
    // ドライバ識別子
    $vg_driver_id                  = DF_PIONEER_DRIVER_ID;
    ...
    // 作業インスタンステーブル名
    $vg_exe_ins_msg_table_name        = "C_ANSIBLE_PNS_EXE_INS_MNG";
    // 作業インスタンスジャーナルテーブル名
    $vg_exe_ins_msg_table_jnl_name    = "C_ANSIBLE_PNS_EXE_INS_MNG_JNL";
    // 変数管理テーブルテーブル名
    $vg_ansible_vars_masterDB         = "B_ANSIBLE_PNS_VARS_MASTER";
    // 代入値管理テーブルテーブル名
    $vg_ansible_vars_assignDB         = "B_ANSIBLE_PNS_VARS_ASSIGN";
    // 代入変数名管理テーブルテーブル名
    $vg_ansible_pattern_vars_linkDB   = "B_ANS_PNS_PTN_VARS_LINK";//B_ANSIBLE_PNS_PTN_VARS_LINK
    // 素材管理テーブル テーブル名
    $vg_ansible_master_fileDB         = "B_ANSIBLE_PNS_DIALOG";
    ...
    // 作業対象ホスト管理テーブルテーブル名
    $vg_ansible_pho_linkDB            = "B_ANSIBLE_PNS_PHO_LINK";
    // 作業インスタンスジャーナルテーブル名 シーケンス管理項目名
    $vg_exe_ins_msg_table_jnl_seq     = "C_ANSIBLE_PNS_EXE_INS_MNG_JSQ";

    // 作業パターン詳細 テーブル名
    $vg_ansible_pattern_linkDB        = "B_ANSIBLE_PNS_PATTERN_LINK";
    // ロールパッケージ管理 テーブル名
