...
$ary[50059] = "Failed to update Last execution date of Operation list. (Execution No.:{})";
...
$ary[56101] = "playbook registered in the Movement playbook link is not registered in the playbook files. (Movement details item No.:{})";
$ary[56102] = "Movement ID is not registered in the Movement playbook link . (Movement ID:{})";
$ary[56103] = "playbook associated with Movement ID of Movement playbook link is not registered. (Movement ID:{})";
...
$ary[56113] = "Dialog file associated with the dialog type of Movement dialogue type link is not registered in the Dialog files. (Movement details Item No.:{})";
$ary[56115] = "Movement ID is not registered in Movement dialogue type link. (Movement ID:{})";
$ary[56116] = "Dialog file associated with the Movement ID of Movement dialogue type link is not registered. (Movement ID:{})";
...
$ary[56214] = "In the case of Movement where winrm connection is selected in the Movement list, devices whose authentication method in the device list is other than password authentication (winrm) cannot be set in the target host list. (host:{})";
$ary[56215] = "If winrm connection is not selected in the Movement list, the device whose authentication method in the device list is password authentication (winrm) cannot be set in the target host list. (host:{})";
$ary[56230] = "If the device list authentication method is password authentication, the login password is a required item. (host:{})";
$ary[56231] = "If the authentication method of the device list is key authentication (no passphrase), the private key file (id_rsa) is a required item. (host:{})";
$ary[56232] = "If the authentication method of the device list is key authentication (with passphrase), the private key file (id_rsa) is a required item. (host:{})";
$ary[56233] = "If the authentication method of the device list is key authentication (with passphrase), the passphrase is a required item. (host:{})";
$ary[56234] = "The authentication method in the device list is not selected. (host:{})";
$ary[56235] = "If the device list authentication method is password authentication, managing the login password is a required item. (host:{})";
$ary[56236] = "The authentication method of the device list is invalid. (host:{})";
$ary[56237] = "The login user ID in the device list has not been entered. (host:{})";
$ary[56238] = "The authentication method of the device list is invalid. Password authentication (winrm) is not supported by pioneer. (host:{})";
$ary[56239] = "The protocol of Pioneer usage information in the device list is not selected. (host:{})";
$ary[56240] = "The protocol of Pioneer usage information in the device list is invalid. (host:{})";
$ary[56250] = "If the authentication method of the Tower host list is password authentication, the login password is a required item. (Ansible Tower:{})";
$ary[56251] = "If the authentication method of the Tower host list is key authentication (no passphrase), the private key file (id_rsa) is a required item. (Ansible Tower:{})";
$ary[56252] = "If the authentication method of the Tower host list is key authentication (with passphrase), the private key file (id_rsa) is a required item. (Ansible Tower:{})";
$ary[56253] = "If the authentication method of the Tower host list is key authentication (with passphrase), the passphrase is a required item. (Ansible Tower:{})";
$ary[56254] = "The authentication method for the Tower host list is not selected. (Ansible Tower:{})";
$ary[56255] = "Reserve.";
$ary[56256] = "Reserve.";
$ary[56257] = "Reserve.";
$ary[56258] = "Reserve.";
$ary[56259] = "Reserve.";
$ary[56260] = "Reserve.";
$ary[56270] = "If the authentication method is password authentication, the login password is a required item.";
$ary[56271] = "If the authentication method is key authentication (no passphrase), the private key file (id_rsa) is a required item.";
$ary[56272] = "If the authentication method is key authentication (with passphrase), the private key file (id_rsa) is a required item.";
$ary[56273] = "If the authentication method is key authentication (with passphrase), the passphrase is a required item.";
$ary[56274] = "No authentication method has been selected.";
$ary[56275] = "Reserve.";
$ary[56276] = "The authentication method is invalid.";
$ary[56277] = "The login user ID has not been entered.";
$ary[56278] = "Reserve.";
$ary[56279] = "Reserve.";
$ary[56280] = "Reserve.";
...
$ary[70010] = "Multiple role packages are registered in Movement role link.";
$ary[70011] = "Role package is not registered in the role package list. (Role package list Item No.: {})";
$ary[70012] = "The role registered in Movement details is not registered in the role package list. (Movement role link Item No.:{})";
$ary[70013] = "The role associated with the Movement ID of Movement role link is not registered. (MovementID:{})";
...
$ary[80007] = "Failed to get the permission role of master data.";
$ary[80008] = "Since the access permission roles of the operation list, device list, and movement list do not match, Skip processing this data.  (menu:{} column: {} operation: {}({}) device list (host): {}({}) movement: {}({}))";
...
$ary[90013] = "Movement registered in the substitution value auto-registration setting is not registered in the Movement role link. This record will be out of scope of processing. (Substitution value auto-registration setting Item No:{})";
...
$ary[90037] = "Operation registered in the associated menu is not registered in the operation list. This record will be out of scope of processing. (MENU_ID:{} Associated menu: Item No..:{} Operation ID:{})";
...
$ary[90071] = "variable is non-registration in roll or roll package registered with the Movement role link.";
$ary[90072] = "Substitution order (Key) is blank.";
$ary[90073] = "Substitution order (Value) is blank.";
$ary[90074] = "variable is non-registration in dialog type registered with the Movement dialogue type link.";
$ary[90075] = "Host is not entered.";
$ary[90076] = "Host is not selected.";
$ary[90077] = "variable is non-registration in playbook registered with the Movement playbook link.";
...
$ary[90226] = "Skip the update of Nested variable list because variable name list was last updated in other process. (Variable:{})";
...
$ary[5000012] = "System managed device list SSH private key file does not exist. (Device list Item No.: {} ssh authentication key file:{})";
$ary[5000013] = "Failed to copy SSH private key file. (Device list Item No.: {} SSH authentication key file:{})";
...
$ary[6000106] = "Copy ansible tower SSH private key file has failed. (file:{})";
...
$ary[6000117] = "Failed to decrypt the Ansible Tower SSH private key file. (file:{})";
