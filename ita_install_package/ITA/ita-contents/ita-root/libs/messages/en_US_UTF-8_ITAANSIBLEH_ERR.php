...
$ary[51068] = "[Process] Call REST API has failed. (Execution No.:{})";
...
$ary[55241] = "Template variable is not registered in the template list. (PlayBook:{} line:{} Template variable:{})";
...
$ary[55255] = "Specific value of variable used in template file is not registered in the substitution value list. (Playbook: {} template file: {} host: {})";
$ary[55256] = "ITA proprietary variable cannot be used in template file because protocol of device list is blank. (Playbook:{} Template file:{} ITA proprietary variable:{} host:{})";
$ary[55257] = "ITA proprietary variable cannot be used in template file because login user ID of device list is blank. (Playbook:{} Template file:{} ITA proprietary variable:{} host:{})";
$ary[55258] = "ITA proprietary variable cannot be used in template file because login password of device list is blank. (Playbook:{} Template file:{} ITA proprietary variable:{} host:{})";
$ary[55259] = "ITA proprietary variable cannot be used in template file because host name of device list is blank. (Playbook:{} Template file:{} ITA proprietary variable:{} host:{})";
$ary[55260] = "Specific value of variable used in template file is not registered in the substitution value list. (Playbook:{} Template file:{} variable:{} host:{})";
$ary[55261] = "ITA proprietary variable cannot be used in template file because protocol of device list is blank. (Playbook:{} Template file:{} ITA proprietary variable:{} host:{})";
$ary[55262] = "ITA proprietary variable cannot be used in template file because login user ID of device list is blank. (Playbook:{} Template file:{} ITA proprietary variable:{} host:{})";
$ary[55263] = "ITA proprietary variable cannot be used in template file because login password of device list is blank. (Playbook:{} Template file:{} ITA proprietary variable:{} host:{})";
$ary[55264] = "ITA proprietary variable cannot be used in template file because host name of device list is blank. (playbook:{} Template file:{} ITA proprietary variable:{} host:{})";
$ary[55265] = "Read template file has failed. (Playbook: {} template file: {})";
...
$ary[55273] = "Template file is not registered in the template list. (Playbook:{} line:{} Template variable:{})";
...
$ary[70075] = "The specific value of the variable is described in multiple rows. (Role package:{} role:{} file:{} line:{})";
$ary[70076] = "Description of - only is not possible. (Role package:{} role:{} file:{} line:{})";
$ary[70077] = "Cannot omit the specific value of member variable. (Role package list:{} role:{} file:{} line:{})";
$ary[70078] = "Description of { } is not possible. (Role package:{} role:{} file:{} line:{})";
$ary[70079] = "Cannot omit member variable. (Role package:{} role:{} file:{} line:{})";
$ary[70080] = "Description of - { } is not possible. (Role package:{} role:{} file:{} line:{})";
$ary[70081] = "Description of - { } is not possible. (Role package:{} role:{} file:{} line:{})";
$ary[70082] = "Failed to create temporary file. (Role package: {} role:{} file:{})";
$ary[70083] = "Failed to write temporary file. (Role package: {} role:{} file:{})";
$ary[70084] = "Cannot find Spyc module path.";
$ary[70085] = "Spyc module is not installed.";
$ary[70086] = "Failed to analyze variable definition. (Role package:{} role:{} file:{} line:{})";
$ary[70087] = "Could not perform analysis due to an unexpected variable definition. (Role package:{} role:{} file:{} line:{})";
$ary[70089] = "Definition of the repetitive hierarchy of the variable does not match. (Role package:{} role:{} file:{} line:{})";
$ary[70090] = "Registration of multiple substitution order is required. (Role package list:{} role:{} file:{} line:{})";
...
$ary[90209] = "Combination of nested variable, substitution order and column order of {} type, which is set in the operation ID({}) Execution Pattern ID({}) Host ID({})> of associated menu (MENU_ID:{} Item No.:{}) and Substitution value auto-registration setting (Item No.:{}), is duplicated with the details of Substitution value auto-registration setting associated with the menu (MENU_ID:>{} Item No.:{}). This record will be out of scope of processing.";
...
$ary[90218] = "This defines that repetition of variable has exceeded 999. (Role package list:{} role:{} file:{} line:{})";
$ary[90220] = "Analysis of variable failed. (Role package:{} role:{} file:{} line:{})";
...
$ary[90237] = "Global variable used in the dialog file is not registered in the global variable list. (Global variable:{})";
$ary[90238] = "Global variable is used in the Playbook, but global variable is not registered in the global variable list.";
$ary[90239] = "Global variable used in playbook is not registered in the global variable list. (Global variable:{})";
$ary[90240] = "Global variable used in the template file is not registered in the global variable list. (playbook:{} template file:{} global variable:{})";
$ary[90093] = "Failed to copy the file list file. (file:{})";
$ary[90242] = "Global variable used in the role is not registered to the global variable list. (role:{} global variable:{})";
...
$ary[5000017] = "Template variable is not registered in the template list. (Template variable:{})";
$ary[5000018] = "Files associated with the Template variables are not registered in the Template list. (Template variable:{})";
...
$ary[5000031] = "Template file is not registered in the template list. (Template variable:{})";
$ary[5000032] = "Template variable is not registered in the template list. (PlayBook:{} Global variable:{} Template variable:{})";
$ary[5000033] = "Template file is not registered in the template list. (Playbook:{} Global variable:{} Template variable:{})";
...
$ary[5000035] = "Server certificate file of system managed device list does not exist. (Device list Item No.: {} server certificate file:{})";
$ary[5000036] = "Failed to copy server certificate file. (Device list Item No.: {} server certificate file:{})";
...
$ary[6040025] = "No organization. (Organization:{})";
