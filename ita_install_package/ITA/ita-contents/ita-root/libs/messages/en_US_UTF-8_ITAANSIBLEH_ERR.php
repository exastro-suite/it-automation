...
$ary[80008] = "Since the access permission roles of the input operation list, device list, and movement list do not match, Skip processing this data.  (menu:{} column: {} operation: {}({}) device list (host): {}({}) movement: {}({}))";
