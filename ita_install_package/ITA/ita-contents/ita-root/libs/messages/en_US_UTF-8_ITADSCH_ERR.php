...
$ary[55274] = "Failed to input a specific value for the variable used in the host vars file. (host:{}  Config:{})";
$ary[55275] = "The credentials variable used in the Config file is not registered in the credentials variable list. (Config:{}  host:{}  Variable:{})";
$ary[55276] = "The system managed PowerShell file does not exist. (KEY_ID:{}  File name:{})";
$ary[55277] = "Failed to copy PowerShell file. (File name:{})";
$ary[55278] = "The system managed Param file does not exist. (KEY_ID:{}  File name:{})";
$ary[55279] = "Failed to copy Param file. (File name:{})";
$ary[55280] = "The system managed .Import file does not exist. (KEY_ID:{}  File name:{})";
$ary[55281] = "Failed to copy Import file. (File name:{})";
$ary[55282] = "The system managed Config Data file does not exist. (KEY_ID:{}  File name:{})";
$ary[55283] = "Failed to copy Config Data file. (File name:{})";
$ary[55284] = "The system managed Compile Options file does not exist. (KEY_ID:{}  File name:{})";
$ary[55285] = "Failed to copy Compile Options file. (File name:{})";
$ary[55286] = "The system managed Certificate file file does not exist. (KEY_ID:{}  File name:{})";
$ary[55287] = "Failed to copy Certificate key file. (File name:{})";
$ary[55288] = "Failed to input a specific value for the Credential variable used in the Config file. (host:{}  Config:{})";
$ary[55289] = "Failed to input a specific value for the Credential variable (password) used in the Config file. (host:{}  Config:{})";
...
$ary[56120] = "Credential variable (password) set in the Config file is not registered in the credential variable list. (host:{}  Config:{})";
...
$ary[56214] = "The Certificate key file for the host registered in the device list is blank. (variable:{})";
$ary[56215] = "The Thumbprint for the host registered in the device list is blank. (variable:{})";
...
$ary[90000] = "Failed to get the associated menu group information.";
$ary[90001] = "Failed to get the associated menu column information. (MENU_ID:{} Error details:{})";
$ary[90002] = "Failed to update the associated menu table list. (MENU_ID:{})";
$ary[90003] = "Failed to update the associated menu column list. (MENU_ID:{} COLUMN:{})";
$ary[90004] = "Failed to discard the associated menu table list.";
$ary[90005] = "Failed to discarded the associated column list.";
...
$ary[90008] = "An Operation ID column is not set in the associated menu. (MENU_ID:{} :OPERATION_ID)";
...
$ary[90017] = "Could not get the item information of the associated menu registered in the Substitution value auto-registration setting. This record will be out of scope of processing. (Substitution value auto-registration setting: Item No:{})";
$ary[90018] = "Could not get the item name of the associated menu registered in the Substitution value auto-registration setting. This record will be out of scope of processing. (Substitution value auto-registration setting Item No:{})";
$ary[90019] = "Registration method registered in the Substitution value auto-registration setting has an out of range value. This record will be out of scope of processing. (Substitution value auto-registration setting Item No:{} Registration method:{})";
...
$ary[90021] = "Variables registered in the Substitution value auto-registration setting are not used in the Config file or template registered in Config files or template list. This record will be out of scope of processing. (Substitution value auto-registration setting: Item No.:{} Variable classification:{})";
$ary[90023] = "The combination of Movement and variables registered in the Substitution value auto-registration setting is not associated with a Movement in Movement details, or is not used in the Config file or Template file associated in Movement details. This record will be out of scope of processing. (Substitution value auto-registration setting: Item No.:{} Variable classification:{})";
$ary[90024] = "The combination of Movement and variables registered in the Substitution value auto-registration setting is not associated with a Movement in Movement details, or is not used in the dialog file associated in Movement details. This record will be out of scope of processing. (Substitution value auto-registration setting: Item No.:{} Variable classification:{})";
$ary[90027] = "The substitution order of variables registered in the Substitution value auto-registration setting is not set. This record will be out of scope of processing. (Substitution value auto-registration setting: Item No.:{} Variable classification:{})";
$ary[90028] = "The column order of variables registered in the Substitution value auto-registration setting is not set. This record will be out of scope of processing. (Substitution value auto-registration setting: Item No.:{} Variable classification:{})";
$ary[90029] = "The substitution order of variables registered in the Substitution value auto-registration setting contains duplicates. Duplicate records will be out of scope of processing. (Substitution value auto-registration setting Item No.:{}/{} Variable classification:{})";
$ary[90030] = "The Column order of variables registered in the Substitution value auto-registration setting contains duplicates. Duplicate records will be out of scope of processing. (Substitution value auto-registration setting Item No.:{}/{} Variable classification:{})";
$ary[90032] = "Failed to get the variable information for each column from the Substitution value auto-registration setting.";
...
$ary[90036] = "Failed to get information of associated menu. Associated menu is out of scope of processing. (MENU_ID:{})";
...
$ary[90042] = "00_loadTable.php of the associated menu is not functioning correctly. Check 00_loadTable.php. (MENU_ID:{})";
$ary[90043] = "A primary key is not set in the associated menu. (MENU_ID:{})";
$ary[90044] = "The primary key column of associated menu is not set in ROW_ID. (MENU_ID:{})";
$ary[90045] = "An Item name in an associated menu has exceeded the prescribed limit (maximum 256 bytes). (MENU_ID:{} Item name:{})";
$ary[90046] = "A space is included in the item name of an associated menu. (MENU_ID:{} Item name:{})";
...
$ary[90049] = "The combination of nested variable and variable classification column order ({}), set in the operation ID({}) MovementID({}) Host ID({}) of the associated menu (MENU_ID:{} Item No.:{}) and Substitution value auto-registration setting (Item No.:{}), is duplicated with the details of the Substitution value auto-registration setting associated with the associated menu (MENU_ID:{} Item No.:{}). This record will be out of scope of processing.";
$ary[90050] = "The combination of variable and substitution order ({}), set in the operation ID({}) MovementID({}) Host ID({}) of the associated menu (MENU_ID:{} Item No.:{}) and Substitution value auto-registration setting (Item No.:{}), is duplicated with the details of the Substitution value auto-registration setting associated with the associated menu (MENU_ID:{} Item No.:{}). This record will be out of scope of processing.";
$ary[90051] = "Failed to register the specific value of the generic variable to the substitution value list.";
$ary[90052] = "Failed to register the specific value of the nested variable for the substitution value list.";
$ary[90053] = "Failed to delete unnecessary data from substitution value list.";
$ary[90054] = "Failed to register operation ID, MovementID and Host ID not registered in the target host.";
$ary[90055] = "Delete the unnecessary data from target host has failed.";
$ary[90056] = "The specific value of the associated menu is not set. This record will be out of scope of processing. (MENU_ID:{} Associated menu item No.:{} Item name:{})";
$ary[90057] = "The specific value of the associated menu has exceeded the prescribed limit (maximum 1024 byte). This record will be out of scope of processing. (MENU_ID:{} Associated menu item No.:{} Item name:{})";
$ary[90058] = "The specific value of the associated menu is blank. (MENU_ID:{} Associated menu item No.:{} Item name:{})";
$ary[90059] = "Menu is not registered in the associated menu.";
$ary[90060] = "Item is not registered in the associated menu.";
$ary[90061] = "A registration method is not selected.";
$ary[90062] = "The registration method is out of range";
...
$ary[90086] = "Could not get the primary key of the associated menu associated with the Substitution value auto-registration setting. This record will be out of scope of processing. (Substitution value auto-registration setting: Item No.:{})";
$ary[90087] = "Failed to get column information from the column list file excluding the Substitution value auto-registration setting from being displayed. (file:{})";
...
$ary[90103] = "It is required to set the member variable for the variable set in the Substitution value auto-registration setting. This record will be out of scope of processing. (Substitution value auto-registration setting: Item No.:{} Variable classification:{})";
$ary[90104] = "Key variable";
$ary[90105] = "Value variable";
$ary[90107] = "You cannot enter member variable for generic variables. (Variable classification:{})";
$ary[90127] = "The following items are duplicated with the records of [Item No.]:({}). n [(Menu group: Menu), (Movement),(Variable)]";
$ary[90128] = "You cannot enter same variables for the Key variable and Value variable.";
...
$ary[90208] = "The substitution order of the Substitution value auto-registration setting is duplicated. (Substitution value auto-registration setting Item No.:{}/{} Variable classification:{})";
...
$ary[90224] = "Skip the update of member variable list because the variable name list was last updated by another process. (Variable:{})";
$ary[90225] = "Skip the update of variable specific value list because the variable name list was last updated pby another process. (Variable:{})";
$ary[90232] = "Variable has an unexpected structure. (Variable:{})";
$ary[90234] = "Failed to create host vars file.";
$ary[90235] = "Failed to get the details of the  global variable from the global variable list.";
$ary[90238] = "Global variable is used in the Config file, but not registered in the global variable list.";
...
$ary[990013] = "Could not open system managed template file.";
$ary[990014] = "The system managed template file does not exist.";
...
$ary[990018] = "HTTP Header Content Parameters: Data relay storage path (ITA) not found.";
$ary[990019] = "HTTP Header Content Parameters: Orchestrater sub-ID not found.";
$ary[990020] = "HTTP Header Content Parameters: Execution No not found.";
$ary[990021] = "HTTP Header Content Parameters: Data relay storage path (DSC) is not found.";
...
$ary[990024] = "A processing status other than execution processing or confirmation processing was detected. (Execution No.{} Processing type:{} )";
$ary[990025] = "The file output destination directory in Data Relay Storage does not exist. (Execution No.{} Path:{})";
$ary[990026] = "Failed to write to file. (Execution No.{} Filename:{})";
$ary[990027] = "Configuration file not found. (Execution No.{} Filename:{})";
$ary[990028] = "Deployment directory for the configuration file not found. (Execution No.{} Filename:{} )";
$ary[990029] = "Device.txt (target node list file) does not exist. (Execution No.{} Filename:{})";
$ary[990030] = "Failed to create a temporary loading file for the Working node information list. (Execution No.{} Filename:{})";
$ary[990031] = "The target node information list could not be written to a temporary file. (Execution No.{} Filename:{})";
$ary[990032] = "An exception occurred when retrieving the target node information list and Device.txt node information could not be retrieved. (Execution No.{} Error messages:{})";
$ary[990033] = "The IP address of the target node is not in IPv4 format. (Execution No.{})";
$ary[990034] = "The IP address of the target node has not been entered. (Execution No.{})";
...
$ary[990042] = "[DSC Compile process] Unable to access the Data Relay Storage configuration file. (Execution No.{} FileName:{})";
...
$ary[990061] = "[DSC Test process] Detected a failure during file creation. (Execution No.{} FileName:{})";
$ary[990062] = "Failed to write to file. (Execution No.{} FileName:{} )";
$ary[990063] = "Device.txt The format of the number of nodes setting is different. (Execution No.{} )";
...
$ary[990068] = "[DSC Emergency stop] Redetection after emergency stop processing: (Unexpected error) The DSC process will continue to operate after the stop operation. (Execution No.{} Target node{} Result{} Status{})";
$ary[990069] = "[DSC Emergency stop] Unexpected error: The DSC process will continue to operate after the stop operation. (Execution No.{} Target node{} Result{} Status{})";
$ary[990070] = "[DSC Emergency stop] Detection after emergency stop processing: Failed to encrypt CIM session parameters. (Execution No.{} Target node{} Result{} Status{})";
$ary[990071] = "[DSC Emergency stop] Detection after emergency stop processing: Failed to instantiate the credential object. (Execution No.{} Target node{} Result{} Status{})";
$ary[990072] = "[DSC Emergency stop] Detection after emergency stop processing: An exception occurred while generating the CIM session. (Execution No.{} Target node{} Result{} Status{})";
$ary[990073] = "[DSC Emergency stop] Detection after emergency stop processing: Failed to get LCM information for the target node. (Execution No.{} Target node{} Result{} Status{})";
