...
$ary[171320] = "Since the access permission roles of the input operation list and movement list do not match, Skip processing this data.  (menu:{} column: {} operation: {}({}) movement: {}({}))";
