...
$ary[10003] = "[{}] END(ERROR)";
$ary[10004] = "Number of processes: Checking-out=[{}], Check-out requested (checking for duplicate requests)=[{}], Check-in complete=[{}], Return (check-in request)=[{}], Diff file=[{}]";
$ary[10005] = "Number of processes: Delete=[{}], Playbook files=[{}], Template list=[{}], File list=[{}], Dialog file materials=[{}], Role package file=[{}]";
$ary[10006] = "Number of processes: HEAT template files=[{}], Environment Configuration files=[{}]";
$ary[10007] = "Number of processes: Input config=[{}]";
$ary[10008] = "Number of processes: Config files=[{}]";
...
$ary[50004] = "Check-in request returned because there was no change in the file.";
$ary[50005] = "Discard due to parent directory being discarded.";
