...
$ary["ITACREPAR_1261"]       = "Selecte \"String\", \"Multi string\", \"Integer\", \"Decimal number\", \"Date\", \"Date/time\",\n\"Pull down selection\" from the pulldown menu.\nWhen “String” is selected, the item is a text box with single line input.\nWhen “Multi string” is selected, the item is a text box with multiple line input.\nWhen “Integer” is selected, the item is a text box that only integer can be entered.\nWhen “Decimal number” is selected, the item is a text box that integer/decimal number\ncan be entered.\nWhen “Date” and “Date/time” is selected, the item is entered by calendar selection.\nWhen “Pulldown selection” is selected, the item is a pulldown menu item.";
