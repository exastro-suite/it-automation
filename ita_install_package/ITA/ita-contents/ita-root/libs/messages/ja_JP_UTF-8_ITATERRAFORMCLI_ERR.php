...
$ary["ITATERRAFORMCLI-ERR-208010"]       = "異常発生(作業No.:{} [FILE]{}[LINE]{})";
$ary["ITATERRAFORMCLI-ERR-208020"]       = "トランザクションスタートが失敗しました。(作業No.:{})";
$ary["ITATERRAFORMCLI-ERR-208030"]       = "履歴シーケンスの採番に失敗しました。(作業No.:{} Sequence:{})";
$ary["ITATERRAFORMCLI-ERR-208040"]       = "トランザクションのコミットに失敗しました。(作業No.:{})";
$ary["ITATERRAFORMCLI-ERR-208050"]       = "ロールバックに失敗しました。(作業No.:{})";

$ary["ITATERRAFORMCLI-ERR-208100"]       = "作業インスタンスの情報取得に失敗しました。(作業No.:{})";
$ary["ITATERRAFORMCLI-ERR-208110"]       = "ステータスの更新に失敗しました。 (ステータス: 準備中 作業No.:{})";
$ary["ITATERRAFORMCLI-ERR-208120"]       = "ステータスの更新に失敗しました。 (ステータス: 実行中 作業No.:{})";
$ary["ITATERRAFORMCLI-ERR-208130"]       = "ステータスの更新に失敗しました。 (ステータス: 実行中(遅延) 作業No.:{})";
$ary["ITATERRAFORMCLI-ERR-208140"]       = "ステータスの更新に失敗しました。 (ステータス: 完了 作業No.:{})";
$ary["ITATERRAFORMCLI-ERR-208150"]       = "ステータスの更新に失敗しました。 (ステータス: 完了(異常) 作業No.:{})";
$ary["ITATERRAFORMCLI-ERR-208160"]       = "ステータスの更新に失敗しました。 (ステータス: 想定外エラー 作業No.:{})";
$ary["ITATERRAFORMCLI-ERR-208170"]       = "ステータスの更新に失敗しました。 (ステータス: 緊急停止 作業No.:{})";
$ary["ITATERRAFORMCLI-ERR-208180"]       = "作業インスタンスの実行プロセスの起動確認が失敗しました。";
$ary["ITATERRAFORMCLI-ERR-208190"]       = "Terraformインターフェース情報レコード無し";
$ary["ITATERRAFORMCLI-ERR-208191"]       = "Terraformインターフェース情報レコードが単一行でない";
$ary["ITATERRAFORMCLI-ERR-208200"]       = "実行中の作業インスタンスの取得に失敗しました。";
$ary["ITATERRAFORMCLI-ERR-208210"]       = "未実行の作業インスタンスの取得に失敗しました。";
$ary["ITATERRAFORMCLI-ERR-208220"]       = "作業インスタンスの実行プロセスが起動していません。(作業No.:{}:{})";
$ary["ITATERRAFORMCLI-ERR-208230"]       = "Movement-Module紐付にMovementIDが登録されていません(MovementID:{})";
$ary["ITATERRAFORMCLI-ERR-208240"]     = "Movementに紐づくModuleが存在しません(MovementID:{})";

$ary["ITATERRAFORMCLI-ERR-208250"]     = "メンバー変数の取得に失敗しました。ID:{}";
$ary["ITATERRAFORMCLI-ERR-208251"]     = "メンバー変数の取得に失敗しました。(FILE:{} LINE:{} ID:{})";
$ary["ITATERRAFORMCLI-ERR-208260"]     = "変数の取得に失敗しました。";
$ary["ITATERRAFORMCLI-ERR-208261"]     = "変数の取得に失敗しました。(FILE:{} LINE:{})";
$ary["ITATERRAFORMCLI-ERR-208270"]     = "ステータスを更新出来ませんでした。(作業No.:{} ステータス:{})";


$ary["ITATERRAFORMCLI-ERR-208300"]     = "ディレクトリの作成に失敗しました。(作業No:{} workspace-id:{} FILE:{} LINE:{})";
$ary["ITATERRAFORMCLI-ERR-208310"]     = "ディレクトリのパーミッション設定に失敗しました。(作業No:{} workspace-id:{} FILE:{} LINE:{})";
$ary["ITATERRAFORMCLI-ERR-208320"]     = "zipファイルの作成に失敗しました。(作業No:{} FILE:{} LINE:{})";
