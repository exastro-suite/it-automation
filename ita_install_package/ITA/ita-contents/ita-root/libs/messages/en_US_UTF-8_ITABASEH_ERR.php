...
$ary[5721202] = "The setting value for Symphony name is not valid. ({})";
...
$ary[1990035] = "Contains a Movement that cannot be specified. (Movement:{} Target host [Item No.]:{})";
$ary[1990036] = "Host should exist for Movement. (Movement:{} Target host [Item No.]:{})";
$ary[1990037] = "Contains a Movement that cannot be specified. (Movement ID:{})";
$ary[1990038] = "Movement playbook link are not registered for Movement. (Movement:{} Target host [Item No.]:{})";
$ary[1990039] = "Movement dialogue type link are not registered for Movement. (Movement:{} Target host [Item No.]:{})";
$ary[1990040] = "Movement role link are not registered for Movement. (Movement:{} Target host [Item No.]:{})";
...
$ary[160001] = "[Process] End procedure (Error)";
$ary[160002] = "[Process] End procedure (Warning)";
$ary[160003] = "[Process] Registration of symphony instance failed (regularlyId:{}).";
$ary[170000] = "The setting value of the Conductor class name is invalid. ({})";
$ary[170001] = "Nodes are not connected to each other.";
$ary[170002] = "The connection destination of Node is invalid.";
$ary[170003] = "The setting value of the Conductor class ID is invalid. ({})";
$ary[170004] = "Movement-The operation ID value is invalid. (MovementID:{} Operation ID:{})";
$ary[170005] = "Movement-Operation ID must exist. (Movement:{})";
$ary[170006] = "ConductorCall-A Conductor class ID that cannot be specified.";
$ary[170007] = "The setting value of the Conductor class display mode is invalid. ({})";
$ary[170008] = "Conductor Class ID: Must exist.";
$ary[170009] = "The setting value of the Conductor instance ID is invalid. ({})";
$ary[170010] = "Conductor Instance ID: Must exist.";
$ary[170011] = "The setting value of Node instance ID is invalid. ({})";
...
$ary[170020] = "ConductorCall - The operation ID value is invalid.(Conductor:{} Operation ID:{})";
$ary[170021] = "SymphonyCall - The operation ID value is invalid.(Symphony:{} Operation ID:{})";
$ary[170022] = "ConductorCall - Operation ID must exist.(Conductor:{})";
$ary[170023] = "SymphonyCall - Operation ID must exist.(Symphony:{})";
$ary[170024] = "ConductorCall - A Operation ID that cannot be specified.";
$ary[170025] = "SymphonyCall - A Operation ID that cannot be specified.";
$ary[170026] = "Movement - A Operation ID that cannot be specified.";
$ary[170027] = "ConductorCall - A Conductor class ID that cannot be specified.";
$ary[170028] = "ConductorCall - Cannot run because an infinite loop occurs.";
$ary[170029] = "ConductorCall - Contains a Conductor Class ID that cannot be specified.(Conductor:{})";
$ary[170030] = "ConductorCall - Contains a Operation ID that cannot be specified.(Conductor:{})";
$ary[170031] = "SymphonyCall - Contains a Operation ID that cannot be specified.(Conductor:{})";
$ary[170032] = "Movement - Contains a Movement that cannot be specified.(Conductor:{})";
$ary[170033] = "Movement - Contains a Operation ID that cannot be specified.(Conductor:{})";
$ary[170034] = "SymphonyCall - Contains a Symphony Class ID that cannot be specified.(Conductor:{})";
