...
$ary[304000] = "Conductorのインターフェース情報をメンテナンス(閲覧/登録/更新/廃止)できます。 <br>本メニューは必ず1レコード>である必要があります。";
$ary[304010] = "No";
...
$ary[307020] = "開始";
$ary[307021] = "終了";
$ary[307022] = "Conductorクラス名";
$ary[307023] = "[元データ]・Conductor一覧";
$ary[307024] = "オペレーション名";
$ary[307025] = "[元データ]投入オペレーション一覧";
$ary[307026] = "自動入力";
$ary[308000] = "Conductorクラスに紐付Nodeを閲覧出来ます。";
...
$ary[308100] = "Nodeクラスに紐付Terminalを閲覧出来ます。";
