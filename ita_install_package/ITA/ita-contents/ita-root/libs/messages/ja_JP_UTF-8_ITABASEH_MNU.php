...
$ary["ITABASEH-MNU-102026"]         = "Ansible Tower(Ansible Automation Controller)利用情報";
...
$ary["ITABASEH-MNU-103052"]         = "Ansible TowerAnsible Automation Controller)認証情報の接続タイプを設定します。通常はmachineを選択します。ansible_connectionをloclaに設定する必要があるネットワーク機器の場合にNetworkを選択します。";
...
$ary["ITABASEH-MNU-104631"]         = "Ansible Tower(Ansible Automation Controller)のインベントリに設定するインスタンスグループを指定します。";
