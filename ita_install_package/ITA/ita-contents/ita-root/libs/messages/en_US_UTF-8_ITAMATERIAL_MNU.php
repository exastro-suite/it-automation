...
$ary[102601] = "Link the file registered in Build file control with a file used in another console, then register it. <br/>Changes will automatically be reflelcted in the registered file every time it is updated in Build file control.";
$ary[102602] = "Item No.";
$ary[102603] = "File link list (Terraform)";
$ary[102604] = "File link list (Terraform)";
$ary[102605] = "File name in link destination";
$ary[102606] = "Enter the file name registered in the link destination.\nIf the file name entered does not exist in the link destination, it will be newly registered.";
$ary[102607] = "File name";
$ary[102608] = "Select the files to link.";
$ary[102609] = "Revision";
$ary[102610] = "Select the desired revision number.\nIf no revision number is selected, the latest revision will be used.\n*If a revision is specified, it will not be updated automatically.";
$ary[102611] = "Select a file name";
$ary[102612] = "Terraform";
$ary[102613] = "Mocule file";
$ary[102614] = "Select \"●\" for the link destination menu.\n*Select only one link destination.";
$ary[102615] = "Policy file";
$ary[102616] = "Select \"●\" for the link destination menu.\n*Select only one link destination.";
?>