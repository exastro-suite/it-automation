...
$ary[102004] = "Menu creation information";
...
$ary[102013] = "Menu group for Host";
...
$ary[102021] = "Vertical menu group";
...
$ary[102402] = "Id";
$ary[102403] = "Menu creation list";
$ary[102404] = "Menu creation list";
...
$ary[102501] = "A menu can be created in the menu group specified in \"Menu creation information\".<br/>* If a menu with the same menu name or menu with the same \"Menu creation information\" ID already exists, the existing data will be deleted and overwritten by the new menu.<br/>If you need to retain the existing data, select \"Cancel\" and perform a backup.";
...
$ary[102507] = "Id";
$ary[102508] = "Menu creation list";
$ary[102509] = "Select the Menu that you want to create.";
$ary[102510] = "Do you want to create the  Menu ?\\n\\n*If a menu with the same menu name or a menu the same 'Menu creation information' ID already exists, the existing data will be deleted and overwritten by the new data.\\nIf you need to retain the existing data, select 'Cancel' and perform a backup.";
