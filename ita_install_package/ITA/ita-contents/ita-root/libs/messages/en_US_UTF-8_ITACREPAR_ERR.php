...
$ary[1160] = "String can not be set when \"Reference item\" is set.";
$ary[1161] = "Multi String can not be set when \"Reference item\" is set.";
$ary[1162] = "Integer can not be set when \"Reference item\" is set.";
$ary[1163] = "Decimal number can not be set when \"Reference item\" is set.";
$ary[1164] = "Date/time can not be set when \"Reference item\" is set.";
$ary[1165] = "Date can not be set when \"Reference item\" is set.";
$ary[1166] = "Password can not be set when \"Reference item\" is set.";
$ary[1167] = "File Upload can not be set when \"Reference item\" is set.";
$ary[1168] = "Link can not be set when \"Reference item\" is set.";
$ary[1169] = "If \"Menu group: Menu:Item\" is not selected, \"Reference item\" cannot be set.";
$ary[1170] = "Only comma-separated IDs can be entered in the Reference item\" field.";
$ary[1171] = "Failed to search \"Reference item information\" table. SQL error = [{}].";
$ary[1172] = "Contains a reference item ID that cannot be selected.。";
