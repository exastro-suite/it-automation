...
$ary["ITABASEH-MNU-102089"]         = "Select the authentication method when connecting to the host from Ansible. \nYou also need to set the login user sudo authority to /etc/sudoers on the host side with NOPASSWD.";
