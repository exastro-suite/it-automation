...
$ary["ITABASEH-MNU-102026"]         = "Ansible Tower(Ansible Automation Controller)Dedicated information";
...
$ary["ITABASEH-MNU-103052"]         = "Sets the connection type for Ansible Tower(Ansible Automation Controller) credentials. Basically, select machine. Select Network for network devices that require ansible_connection set to locla.";
...
$ary["ITABASEH-MNU-104631"]         = "Specify the instance group to be set as the inventory of Ansible Tower(Ansible Automation Controller).";
