...
//
    ...
    function AddSelectTagToDynamicSelectTab($objTable, $strFormatterId, $intColumnSeq, &$aryVariant=array(), &$arySetting=array(), $aryOverride=array()){
        global $g;
        ...
        $defaultValueOnFx = array("SingleRow1Tbl");
        ...
        try{
            ...
            $retArray = checkCommonSettingVariants($strFxName, $objTable, $aryVariant, $arySetting, "SingleRowTableFormatter", $strFormatterId);
            ...
            foreach($aryObjColumn as $focusColumn){
                ...
                if( $focusObjOT->isVisible() === true ){
                    ...
                    if( $intColumnSeq == $intPrintSeq ){
                        ...
                        if( is_a($objFocusCF, "SelectTabBFmt") === true )
                        {
            ...
            $strShowTable01TagId = $objListFormatter->getGeneValue("tableTagIdForSingleRow",$refRetKeyExists);
