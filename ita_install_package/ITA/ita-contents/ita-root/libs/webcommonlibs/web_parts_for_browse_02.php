                    ...
                    <div class="headerInformation"> 
                      ...
                      <div class="itaLoginUserInformation">
                        <div class="itaLoginUserData">
                          <div class="itaLoginUserName"><?= $objMTS->getSomeMessage("ITAWDCH-STD-501",$username_jp) ?></div>
                          <div class="itaLoginUserID"><?= $objMTS->getSomeMessage("ITAWDCH-STD-502",$username) ?></div>
                        </div>
