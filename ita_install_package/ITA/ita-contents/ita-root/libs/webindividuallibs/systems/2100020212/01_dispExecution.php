...
//
    ...
    $execution_management_dir = "2100020213";
    
    //----オーケストレータ別の設定記述
    
    $strExeTableIdForSelect = 'E_ANSIBLE_PNS_EXE_INS_MNG';
...
<<< EOD
                ...
                <table id="DbTable_Yobi0">
                    <tr class="defaultExplainRow">
                        ...
                        <th scope="row" rowspan="1" colspan="1" class="noBorderBoth"  ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-103085")}</span><!--項目//--></th>
                        <th scope="row" rowspan="1" colspan="1" class="noBorderLeft"  ><span class="generalBold"></th>
                        <th scope="row" rowspan="1" colspan="1" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-103090")}</span><!--値//--></th>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="3" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-104010")}</span><!--作業№//--></td>
                        <td                                     >{$COLUMN_01}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="3" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-104015")}</span><!--実行種別//--></td>
                        <td                                     >{$COLUMN_08}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="3" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-105080")}</span><!--ステータス//--></td>
                        <td                                     >{$COLUMN_14}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="2" colspan="1" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-104041")}</span><!--Ansible利用情報//--></td>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="1" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-104042")}</span><!--ホスト指定形式//--></td>
                        <td                                     >{$COLUMN_35}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="likeHeader" scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-104070")}</span><!--№//--></td>
                        <td                                     >{$COLUMN_04}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-104080")}</span><!--名//--></td>
                        <td                                     >{$COLUMN_05}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-104085")}</span><!--ID//--></td>
                        <td                                     >{$COLUMN_33}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="1" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-104090")}</span><!--入力データ//--></td>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-105010")}</span><!--投入データ//--></td>
                        <td                                     >{$COLUMN_06}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="1" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-105020")}</span><!--出力データ//--></td>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-105030")}</span><!--結果データ//--></td>
                        <td                                     >{$COLUMN_07}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="3" colspan="1" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-105040")}</span><!--作業状況//--></td>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-105050")}</span><!--予約日時//--></td>
                        <td                                     >{$COLUMN_11}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-105060")}</span><!--開始日時//--></td>
                        <td                                     >{$COLUMN_12}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-105070")}</span><!--終了日時//--></td>
                        <td                                     >{$COLUMN_13}</td>
                    </tr>
                </table>
                </div>
