...
//
function symphonyNoRegisterFromRest($strCalledRestVer,$strCommand,$objJSONOfReceptedData){
    global $g;
    ...
    try{
        ...
        list($intSymphonyClassId       , $boolKeyExists) = isSetInArrayNestThenAssign($tmpAryOrderData ,array('SYMPHONY_CLASS_NO') ,null);
...
function symphonyNoRegister($intShmphonyClassId, $intOperationNo, $strPreserveDatetime, $strOptionOrderStream){
    global $g;
    ...
    try{
        ...
        $aryRetBody = symphonyInstanceConstuct($intShmphonyClassId, $intOperationNo, $strPreserveDatetime, $strOptionOrderStream);
        if( $aryRetBody[1] !== null ){
            $intErrorType = $aryRetBody[1];
