...
<<< EOD
                ...
                <table id="DbTable_Yobi0">
                    ...
                    <tr> 
                        <td class="likeHeader" scope="row" rowspan="9" colspan="1" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-101080")}</span><!--作業パターン//--></td>
                    ...
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="1" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-9010000013")}</span><!--Tower利用情報//--></td>
