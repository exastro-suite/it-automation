...
//
    ...
    try{
        ...
        // ステータスIDによって処理を分岐                             //
        ////////////////////////////////////////////////////////////////
        // ステータスIDが未実行(予約)(2)以外の場合
        if( $status_id != 2 ){
            // エラー箇所をメモ
            $warning_info = $g['objMTS']->getSomeMessage("ITAOPENST-ERR-102040",$status_name);
        ...
        // 正常向けの結果メッセージを作成
        $output_str = $g['objMTS']->getSomeMessage("ITAOPENST-STD-102050",$target_execution_no);
    }
    catch (Exception $e){
        //----正常時でも飛ばす版
