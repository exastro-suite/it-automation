...
//
    ...
    //----オーケストレータ別の設定記述
    $varOrchestratorId = 11;
    $strOrchRPath = "terraform_cli_driver";
    //オーケストレータ別の設定記述----
    ...
    if( $objIntNumVali->isValid($target_execution_no) === false ){
        // エラー箇所をメモ
        $error_info = '[FILE]' . __FILE__ . ',[LINE]' . __LINE__ . ',[MESSAGE]' . $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-ERR-204010");
    }
    else{
