...
////////////////////////////////////////////////////////////////////////
//  Movement作業実行RestAPI [ INFO / CANCEL / SCRAM ] (Terraform-CLI) //
////////////////////////////////////////////////////////////////////////
function movementExecutionControlFromRest($strCalledRestVer,$strCommand,$objJSONOfReceptedData){
    ...
    if ( $g['page_dir'] == "2100200009" || $g['page_dir'] == "2100200010" ) $OrchestratorDB="E_TERRAFORM_CLI_EXE_INS_MNG";   //Terraform-CLI
...
function getInfoOfOneExeInstance($target_execution_no,$strExeTableIdForSelect){
    ...
    switch ($strExeTableIdForSelect) {
        ...
        //     break;
        // case 'E_TERRAFORM_EXE_INS_MNG':
        case 'E_TERRAFORM_CLI_EXE_INS_MNG':
                $sql = "SELECT  TAB_A.EXECUTION_NO,
                                TAB_A.SYMPHONY_NAME,
                                TAB_A.EXECUTION_USER,
                                TAB_A.PATTERN_ID,
