...
//
    ...
    $execution_management_dir = "2100200011";

    //----オーケストレータ別の設定記述
    $strExeTableIdForSelect = 'E_TERRAFORM_CLI_EXE_INS_MNG';
    //オーケストレータ別の設定記述----
    ...
    try{
        ...
        $COLUMN_36 = nl2br(htmlspecialchars($showTgtRow['I_TERRAFORM_WORKSPACE']));
        ...
        // 代入値管理へ遷移するボタン生成
        $caption = $g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140290");
        if (empty($ope_param) && empty($movement_param)) {
            $COLUMN_39 = "";
        } else {
            $url = sprintf("/default/menu/01_browse.php?no=2100200008&ope_id=%s&movement_id=%s", $ope_param,$movement_param);
            $COLUMN_39 =  sprintf("<input class=\"linkBtnInTbl\" type=\"button\" value=\"%s\" onClick=\"window.open('%s')\">",$caption,$url);
        }

        // Movement一覧へ遷移するボタン生成
        $caption = $COLUMN_32;
        $url = sprintf("/default/menu/01_browse.php?no=2100200003&movement_id=%s",$movement_param);
        if (!empty($caption)) {
...
<<< EOD
                ...
                <table id="DbTable_Yobi0">
                    <tr class="defaultExplainRow">
                        ...
                        <th scope="row" rowspan="1" colspan="1" class="noBorderBoth"  ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140010")}</span><!--項目//--></th>
                        <th scope="row" rowspan="1" colspan="1" class="noBorderLeft"  ><span class="generalBold"></th>
                        <th scope="row" rowspan="1" colspan="1" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140020")}</span><!--値//--></th>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="3" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140030")}</span><!--作業№//--></td>
                        <td                                     >{$COLUMN_01}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="3" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140040")}</span><!--実行種別//--></td>
                        <td                                     >{$COLUMN_08}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="3" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140050")}</span><!--ステータス//--></td>
                        <td                                     >{$COLUMN_14}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="3" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140060")}</span><!--呼出元Symphony//--></td>
                        <td                                     >{$COLUMN_43}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="3" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140070")}</span><!--呼出元Conductor//--></td>
                        <td                                     >{$COLUMN_44}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="3" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140080")}</span><!--実行ユーザ//--></td>
                        <td                                     >{$COLUMN_42}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="4" colspan="1" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140090")}</span><!--Movement//--></td>
                        <td class="likeHeader"  scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140100")}</span><!--ID//--></td>
                        <td                                     >{$COLUMN_31}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140110")}</span><!--名称//--></td>
                        <td                                     >{$COLUMN_40}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140120")}</span><!--遅延タイマ(分)//--></td>
                        <td                                     >{$COLUMN_03}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="1" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140130")}</span><!--Terraform利用情報//--></td>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="1" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140140")}</span><!--Workspace//--></td>
                        <td                                     >{$COLUMN_36}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="3" colspan="1" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140160")}</span><!--オペレーション//--></td>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140170")}</span><!--№//--></td>
                        <td                                     >{$COLUMN_04}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140180")}</span><!--名称//--></td>
                        <td                                     >{$COLUMN_05}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140190")}</span><!--ID//--></td>
                        <td                                     >{$COLUMN_33}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="3" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140200")}</span><!--代入値//--></td>
                        <td                                     >{$COLUMN_39}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="1" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140210")}</span><!--入力データ//--></td>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140220")}</span><!--投入データ//--></td>
                        <td                                     >{$COLUMN_06}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="1" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140230")}</span><!--出力データ//--></td>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140240")}</span><!--結果データ//--></td>
                        <td                                     >{$COLUMN_07}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="3" colspan="1" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140250")}</span><!--作業状況//--></td>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140260")}</span><!--予約日時//--></td>
                        <td                                     >{$COLUMN_11}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140270")}</span><!--開始日時//--></td>
                        <td                                     >{$COLUMN_12}</td>
                    </tr>
                    <tr>
                        <td class="likeHeader" scope="row" rowspan="1" colspan="2" ><span class="generalBold">{$g['objMTS']->getSomeMessage("ITATERRAFORMCLI-MNU-140280")}</span><!--終了日時//--></td>
                        <td                                     >{$COLUMN_13}</td>
                    </tr>
                </table>
                </div>
