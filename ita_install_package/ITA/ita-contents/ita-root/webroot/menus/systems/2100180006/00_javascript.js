...
function Mix1_1_scramSymphonyInstance(symphony_instance_id){

    var res = window.confirm( "強制停止を実施しますか" )
    if( res == true ) {
        //var result_A = scramSymphonyInstance(symphony_instance_id);
        alert('___');
        // 遷移先URLを作成
        var url = '/menus/systems/2100180006/03_data_export.php?conductor_instance_id=' + symphony_instance_id;
...
function Mix1_1_bookCancelSymphonyInstance(symphony_instance_id){
    var res = confirm( "予約キャンセルを実施しますか" )

    if( res == true ) {
        //var result_A = bookCancelSymphonyInstance(symphony_instance_id);
