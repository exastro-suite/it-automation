...
<!-- サイト個別html要素、ここから//-->
    ...
    <h2>
        <table width="100%">
            <tr>
                <td><div onClick=location.href="javascript:show('UserBrowseMidashi','UserBrowseNakami');" class="midashi_class" >{$g['objMTS']->getSomeMessage("ITAWDCH-MNU-1069091")}</div></td>
                <td>
                    <div id="UserBrowseMidashi" align="right">
                        <input type="button" value="{$strCmdWordAreaClose}" class="showbutton" onClick=location.href="javascript:show('UserBrowseMidashi','UserBrowseNakami');" >
                    </div>
                </td>
            </tr>
        </table>
    </h2>
    <div id="UserBrowseNakami" style="display:block" class="text">
        <div style="margin-left:10px">
            <h3>{$g['objMTS']->getSomeMessage("ITAWDCH-MNU-1069092")}</h3>
            <div id="UserBrowse_header_area"></div>
            <h3>{$g['objMTS']->getSomeMessage("ITAWDCH-MNU-1069093")}</h3>
            <div id="UserBrowse_area"></div>
        </div>
    </div>
    <!-------------------------------- メニュー閲覧 -------------------------------->
    <h2>
        <table width="100%">
            <tr>
                <td><div onClick=location.href="javascript:show('MenuBrowseMidashi','MenuBrowseNakami');" class="midashi_class" >{$g['objMTS']->getSomeMessage("ITAWDCH-MNU-1069094")}</div></td>
                <td>
                    <div id="MenuBrowseMidashi" align="right">
                        <input type="button" value="{$strCmdWordAreaClose}" class="showbutton" onClick=location.href="javascript:show('MenuBrowseMidashi','MenuBrowseNakami');" >
                    </div>
                </td>
            </tr>
        </table>
    </h2>
    <div id="MenuBrowseNakami" style="display:block" class="text">
        <div style="margin-left:10px">
            <h3>{$g['objMTS']->getSomeMessage("ITAWDCH-MNU-1069095")}</h3>
            <div id="MenuBrowse_header_area"></div>
            <h3>{$g['objMTS']->getSomeMessage("ITAWDCH-MNU-1069096")}</h3>
            <div id="MenuBrowse_area"></div>
        </div>
    </div>
<!-- サイト個別html要素、ここまで//-->
EOD;
