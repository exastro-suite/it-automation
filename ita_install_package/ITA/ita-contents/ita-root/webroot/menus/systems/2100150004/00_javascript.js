...
callback.prototype = {  
    ...
    ,
    Filter1Tbl_showDl : function(result){
        ...
        var objPrintArea=$('#'+strMixOuterFrameName+' .material_dl_area').get()[0];
...
function print_async( intPrintMode ){
    ...
    // proxy.Filter1Tbl_showDl実行
    proxy.Filter1Tbl_showDl(filter_data);
}
//////// 検索条件指定用ファンクション---- ////////
...
function setDefault(){
    var objTgtNum = document.getElementById('Filter1Tbl_7');
    objTgtNum.value = "●";
}
