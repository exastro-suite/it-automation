...
function newOpenWindow(currentText){
  ...
  var url = "01_browse.php?no=2100080013&filter=on&Filter1Tbl_2=" + searchText;
  window.open(url, '_blank');
}
function newOpenWindow2(currentText){
  var searchText = decodeURIComponent(escape(atob(currentText)));;
  var url = "01_browse.php?no=2100080014&filter=on&Filter1Tbl_2=" + searchText;
  window.open(url, '_blank');
}
