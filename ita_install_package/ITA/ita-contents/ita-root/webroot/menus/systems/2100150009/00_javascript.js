...
callback.prototype = {  
    ...
    ,
    //----資材名
    Mix1_1_fileId_upd : function( result ){
    ...
    Mix2_1_fileId_reg : function( result ){
...
function Mix1_1_fileId_upd(){
    var rangeId = 'Mix1_1';
    
    var fileId = document.getElementById('Mix1_1_2');
    proxy.Mix1_1_fileId_upd(fileId.value);
}
function Mix2_1_fileId_reg(){
    var rangeId = 'Mix2_1';
    
    var fileId = document.getElementById('Mix2_1_2');
    proxy.Mix2_1_fileId_reg(fileId.value);
}
