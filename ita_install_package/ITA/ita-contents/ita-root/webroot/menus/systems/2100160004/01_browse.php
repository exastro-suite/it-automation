...
//
    ...
    //  【特記事項】
    //     表記規則
    //     ・EOD～EOD内に複数行に渡る値をもちうる変数埋込をする場合は、行頭に配置する
    ...
    $aryImportFilePath[] = $objMTS->getTemplateFilePath("ITACREPAR","STD","_js");
...
<<<EOD
<!-- サイト個別html要素、ここから//-->
<input type="hidden" id="start_no" value= $_POST[start_no] >
<input type="hidden" id="end_no" value= $_POST[end_no] >
<!-- サイト個別html要素、ここまで//-->
EOD;
}else{
    print 
<<<EOD
<!-- サイト個別html要素、ここから//-->
<input type="hidden" id="start_no" value="" >
<input type="hidden" id="end_no" value="" >
<!-- サイト個別html要素、ここまで//-->
EOD;
}
    print 
