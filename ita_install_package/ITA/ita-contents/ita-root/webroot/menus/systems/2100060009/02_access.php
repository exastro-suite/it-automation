...
//
    ...
    class Db_Access_Core {
        ...
        function Filter1Tbl_add_selectbox($int_seq_no){
            ...
            $dsc_pattern_dir = "2100060002";
            require_once($g['root_dir_path'] . "/webconfs/systems/{$dsc_pattern_dir}_loadTable.php");
            $objTable1 = loadTable($dsc_pattern_dir,$aryTmpVariant,$aryTmpSetting);
