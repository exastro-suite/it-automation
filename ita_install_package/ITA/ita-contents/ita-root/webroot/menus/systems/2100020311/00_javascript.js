...
callback.prototype = {  
    ...
    Mix1_1_view_val_upd : function( result ){
        var tableTagAreaWrap = 'Mix1_Nakami';
        var strTableTagPrintId = 'Mix1_1';
        var containerClassName = 'fakeContainer_Update1';
        ...
        var objVarsVal = document.getElementById('dummy_upd');
        objVarsVal.innerHTML = ary_result[2];
    ...
    Mix2_1_view_val_reg : function( result ){
        var tableTagAreaWrap = 'Mix2_Nakami';
        var strTableTagPrintId = 'Mix2_1';
        var containerClassName = 'fakeContainer_Register2';
        ...
        var objVarsVal = document.getElementById('dummy_reg');
        objVarsVal.innerHTML = ary_result[2];
    ...
    Mix1_1_view_val_initdisp : function( result ){
        var tableTagAreaWrap = 'Mix1_Nakami';
        var strTableTagPrintId = 'Mix1_1';
        var containerClassName = 'fakeContainer_Update1';
...
function Mix1_1_update_async( mode, inner_seq, updateAreaName ){
    ...
    if(exec_flag){
        ...
        if( mode == 1 ){
            Mix1_1_view_val_initdisp(inner_seq);
        }
    }
}
//////// 更新画面遷移用ファンクション---- ////////
...
function Mix1_1_pattern_upd(){
    ...
    proxy.Mix1_1_pattern_upd(objOpe.value, objPattern.value);
...
function Mix2_1_pattern_reg(){
    ...
    proxy.Mix2_1_pattern_reg(objOpe.value, objPattern.value);
...
// 変数の具体値表示対応
// 更新時の具体値表示トリガー
function Mix1_1_view_val_upd(){
    var rangeId = 'Mix1_1';
    
    var objPtn    = document.getElementById('Mix1_1_2'); //作業パターン
    var objPtn_val = '';
    if( objPtn ){
        objPtn_val = objPtn.value;
    }

    var objVar    = document.getElementById('Mix1_1_4'); //変数名
    var objVar_val = '';
    if( objVar ){
        objVar_val = objVar.value;
    }

    var objChlVar = document.getElementById('Mix1_1_5'); //メンバー変数名
    var objChlVar_val = '';
    if( objChlVar ){
    ...
    proxy.Mix1_1_view_val_upd(objPtn_val, objVar_val, objChlVar_val, objAssSeq_val);
}
// 登録時の具体値表示トリガー
function Mix2_1_view_val_reg(){
    var rangeId = 'Mix2_1';
    
    var objPtn    = document.getElementById('Mix2_1_2'); //作業パターン
    var objPtn_val = '';
    if( objPtn ){
        objPtn_val = objPtn.value;
    }

    var objVar    = document.getElementById('Mix2_1_4'); //変数名
    var objVar_val = '';
    if( objVar ){
        objVar_val = objVar.value;
    }

    var objChlVar = document.getElementById('Mix2_1_5'); //メンバー変数名
    var objChlVar_val = '';
    if( objChlVar ){
        objChlVar_val = objChlVar.value;
    }
    ...
    proxy.Mix2_1_view_val_reg(objPtn_val, objVar_val, objChlVar_val, objAssSeq_val);
}
function Mix1_1_view_val_initdisp(inner_seq){
    proxy.Mix1_1_view_val_initdisp(inner_seq);
}
...
function Mix1_1_vars_upd(){
    ...
    var objVars = document.getElementById('Mix1_1_4');
...
function Mix2_1_vars_reg(){
    ...
    var objVars = document.getElementById('Mix2_1_4');
