...
//
    ...
    class Db_Access extends Db_Access_Core {
        ...
        function Mix1_1_vars_upd($strVarsLinkIdNumeric)
        {
            ...
            $aryVariant = array('VAL_VARS_LINK_ID'=>$strVarsLinkIdNumeric);
        ...
        function Mix1_1_val_chlVar_upd($objVarID, $objChlVarID){
            ...
            $aryVariant = array('VAL_VARS_LINK_ID'=>$objVarID, 'VAL_COL_SEQ_COMBINATION_ID' => $objChlVarID);
        ...
        function Mix1_1_key_chlVar_upd($objVarID, $objChlVarID){
            ...
            $aryVariant = array('KEY_VARS_LINK_ID'=>$objVarID, 'KEY_COL_SEQ_COMBINATION_ID' => $objChlVarID);
