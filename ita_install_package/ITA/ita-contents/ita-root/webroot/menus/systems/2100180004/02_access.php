...
//
    ...
    class Db_Access_Core {
        ...
        function printOperationInfo($intOperationNo){
            ...
            require_once($g['root_dir_path']."/libs/webindividuallibs/systems/"."2100000308"."/81_print_operation_info.php");
        ...
        //  シンフォニーインスタンス作成  //
        ////////////////////////////////////
        #zfunction ConductorExecute($intShmphonyClassId, $intOperationNo, $strPreserveDatetime, $strOptionOrderStream){
        function symphonyExecute($intShmphonyClassId, $intOperationNo, $strPreserveDatetime, $strOptionOrderStream){
            ...
            $arrayResult = conductorNoRegister($intShmphonyClassId, $intOperationNo, $strPreserveDatetime, $strOptionOrderStream); 
        ...
        //  Concuctorインスタンス作成  //
        ////////////////////////////////////
        function conductorExecute($intConductorClassId, $intOperationNo, $strPreserveDatetime, $strOptionOrderStream){
            // グローバル変数宣言
            global $g;
            // ローカル変数宣言
            $arrayResult = array();
            ...
            //整形
            $tmpReceptData = json_decode($strOptionOrderStream,true);
            ...
            require_once($g['root_dir_path']."/libs/webindividuallibs/systems/".$g['page_dir']."/82_conductor_no_register.php");
            $arrayResult = conductorNoRegister($intConductorClassId, $intOperationNo, $strPreserveDatetime, $strSortedData);
