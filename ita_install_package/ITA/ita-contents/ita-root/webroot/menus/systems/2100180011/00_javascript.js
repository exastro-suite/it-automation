...
function Mix1_1_jumpToSymphonyIntList(obj){
    ...
    var strUserName = targetRecort.find('td').eq(7).html(); //実行ユーザ
    ...
    // 遷移先URLを作成
    var url = '/default/menu/01_browse.php?no=2100180006'+'&symphony_name='+strSymphonyName+'&operation_name='+strOperationName+'&user_name='+strUserName;
