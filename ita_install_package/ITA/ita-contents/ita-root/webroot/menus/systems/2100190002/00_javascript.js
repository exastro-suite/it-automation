...
callback.prototype = {  
    ...
    ,
    //----比較項目
    Mix1_1_contrast_menu_upd : function( result ){
    ...
    Mix2_1_contrast_menu_reg : function( result ){
...
function Mix1_1_contrast_menu_upd(){
    var rangeId = 'Mix2_1';
    
    var objOpe = document.getElementById('update_table1');
    var objOpe = $('[id="update_table1"]').val();
    proxy.Mix1_1_contrast_menu_upd(objOpe);

}
function Mix2_1_contrast_menu_reg(){    
    var rangeId = 'Mix2_1';
    var objOpe = document.getElementById('register_table1');
    var objOpe = $('[id="register_table1"]').val();
    proxy.Mix2_1_contrast_menu_reg(objOpe);
}
