...
callback.prototype = {
    ...
    registerOrganization : function(result){
        ...
        if(result == true){
            ...
            //登録失敗通知メッセージ
            window.alert(getSomeMessage("ITATERRAFORM100005"));
            Filter1Tbl_search_async();
    ...
    updateOrganization : function(result){
        ...
        if(result == true){
            ...
            //更新失敗通知メッセージ
            window.alert(getSomeMessage("ITATERRAFORM100007"));
            Filter1Tbl_search_async();
    ...
    deleteOrganization : function(result){
        ...
        if(result == true){
            ...
            //削除失敗通知メッセージ
            window.alert(getSomeMessage("ITATERRAFORM100009"));
            Filter1Tbl_search_async();
        }
...
function Mix1_1_registerOrganization(obj, organizationID){
    ...
    //登録実行確認メッセージ
    if( window.confirm(getSomeMessage("ITATERRAFORM100001"))){
        proxy.registerOrganization(data);
    }
}
...
function Mix1_1_updateOrganization(obj, organizationID){
    ...
    //更新実行確認メッセージ
    if( window.confirm(getSomeMessage("ITATERRAFORM100002"))){
        proxy.updateOrganization(data);
    }
}
...
function Mix1_1_deleteOrganization(obj, organizationID){
    ...
    //削除実行確認メッセージ
    if( window.confirm(getSomeMessage("ITATERRAFORM100003"))){
