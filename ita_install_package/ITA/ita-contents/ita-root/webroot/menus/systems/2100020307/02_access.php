...
//
    ...
    class Db_Access extends Db_Access_Core {
        ...
        function Mix1_1_package_upd($strOperationNumeric){
            // グローバル変数宣言
            global $g;
            ...
            $aryVariant = array('ROLE_PACKAGE_ID'=>$strOperationNumeric);
        ...
        function Mix2_1_package_reg($strRolePackageNumeric){
            // グローバル変数宣言
            global $g;
            ...
            $aryVariant = array('ROLE_PACKAGE_ID'=>$strRolePackageNumeric);
