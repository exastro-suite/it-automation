...
callback.prototype = {  
    ...
    ,
    //----オペレーション
    Mix1_1_package_upd : function( result ){
    ...
    Mix2_1_package_reg : function( result ){
...
function Mix1_1_package_upd(){
    ...
    proxy.Mix1_1_package_upd(objOpe.value);
}
function Mix2_1_package_reg(){
    // すべての後選択関連カラムを消す
    ...
    proxy.Mix2_1_package_reg(objOpe.value);
}
