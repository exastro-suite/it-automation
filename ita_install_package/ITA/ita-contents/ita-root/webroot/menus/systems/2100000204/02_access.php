...
//
    ...
    class Db_Access extends Db_Access_Core {
        ...
        ////////////////////////////////////////
        function dispMenuListHeader( $p_menu_group_id ){
            // グローバル変数宣言
            global $g;
            ...
            // 本体ロジックをコール
            require_once ( $g['root_dir_path'] . "/libs/webindividuallibs/systems/{$g['page_dir']}/81_dispMenuListHeader.php");
        ...
        //  dispMenuListファンクション  //
        //////////////////////////////////
        function dispMenuList( $p_menu_group_id ){
            // グローバル変数宣言
            global $g;
            ...
            // 本体ロジックをコール
            require_once ( $g['root_dir_path'] . "/libs/webindividuallibs/systems/{$g['page_dir']}/82_dispMenuList.php");
