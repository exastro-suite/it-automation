...
<!-- サイト個別html要素、ここから//-->
    ...
    <h2>
        <table width="100%">
            <tr>
                <td><div onClick=location.href="javascript:show('MenuBrowseMidashi','MenuBrowseNakami');" class="midashi_class" >{$g['objMTS']->getSomeMessage("ITAWDCH-MNU-1030091")}</div></td>
                <td>
    ...
    <div id="MenuBrowseNakami" style="display:block" class="text">
        <div style="margin-left:10px">
            <h3>{$g['objMTS']->getSomeMessage("ITAWDCH-MNU-1030092")}</h3>
            <div id="MenuBrowse_header_area"></div>
            <h3>{$g['objMTS']->getSomeMessage("ITAWDCH-MNU-1030093")}</h3>
