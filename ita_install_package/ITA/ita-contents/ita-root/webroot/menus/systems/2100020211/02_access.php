...
//
    ...
    class Db_Access_Core {
        ...
        function Filter1Tbl_add_selectbox($int_seq_no){
            ...
            //----2018/06/11
            //$ansible_legacy_pattern_dir = dirname($g['page_dir'])."/pattern_list";
            //require_once($g['root_dir_path']."/webconfs".$ansible_legacy_pattern_dir."/00_loadTable.php");
            $ansible_legacy_pattern_dir = "2100020203";
            require_once($g['root_dir_path'] . "/webconfs/systems/{$ansible_legacy_pattern_dir}_loadTable.php");
            //2018/06/11----
            $objTable1 = loadTable($ansible_legacy_pattern_dir,$aryTmpVariant,$aryTmpSetting);
        ...
        function printPetternInfo($intPatternNo){
            // グローバル変数宣言
            global $g;
            ...
            $ola_common_lib_dir = "libs/webcommonlibs/orchestrator_link_agent";
            require_once($g['root_dir_path']."/".$ola_common_lib_dir."/71_basic_common_lib.php");
            require_once($g['root_dir_path']."/libs/webindividuallibs/systems/".$g['page_dir']."/82_print_pattern_info.php");
            
            $arrayResult = printPetternInfoForRegisterationSelect($intPatternNo);
        ...
        function orchestratorExecute($intPatternId, $intOperationNoUAPK, $strPreserveDatetime, $aryVars){
            // グローバル変数宣言
            global $g;
            ...
            $arrayResult = executionNoRegister($intPatternId, $intOperationNoUAPK, $strPreserveDatetime, $aryVars);
