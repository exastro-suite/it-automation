...
<?php endif; ?>
<?php
$timeStamp_style_css = filemtime("$root_dir_path/webroot/menus/systems/2100000212/style.css");
print <<< EOD
    <link rel="stylesheet" type="text/css" href="{$scheme_n_authority}/menus/systems/2100000212/style.css?{$timeStamp_style_css}">
EOD;
?>
                        ...
                        <div>
                            <p class="export_radio_label_block">
                                <label id="export_radio1" class="export_label">
                                    <input type="radio" disabled="true" class="export_radio" value="1" name="dp_mode" for="export_radio1" <?php if ($_SESSION["dp_info"]["DP_MODE"]["ID"] == '1' ) echo 'checked';?>>
                        ...
                        <div>
                            <p class="export_radio_label_block">
                                <label id="export_radio3" class="export_label">
                                    <input type="radio" disabled="true"  class="export_radio" value="1" name="abolished_type" for="export_radio3" <?php if ($_SESSION["dp_info"]["ABOLISHED_TYPE"]["ID"] == '1' ) echo 'checked';?>>
                            ...
                            <p class="export_radio_label_block">
                                <label id="export_radio4" class="export_label">
                                    <input type="radio" disabled="true"  class="export_radio" value="2" name="abolished_type" for="export_radio3" <?php if ($_SESSION["dp_info"]["ABOLISHED_TYPE"]["ID"] == '2' ) echo 'checked';?>>
