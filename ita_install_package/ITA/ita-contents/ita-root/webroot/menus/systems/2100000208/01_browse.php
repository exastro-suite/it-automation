...
<!-- サイト個別html要素、ここから//-->
    ...
    <h2>
        <table width="100%">
            <tr>
                <td><div onClick=location.href="javascript:show('RoleBrowseMidashi','RoleBrowseNakami');" class="midashi_class" >{$g['objMTS']->getSomeMessage("ITAWDCH-MNU-1070091")}</div></td>
                <td>
    ...
    <div id="RoleBrowseNakami" style="display:block" class="text">
        <div style="margin-left:10px">
            <h3>{$g['objMTS']->getSomeMessage("ITAWDCH-MNU-1070092")}</h3>
            <div id="RoleBrowse_header_area"></div>
            <h3>{$g['objMTS']->getSomeMessage("ITAWDCH-MNU-1070093")}</h3>
