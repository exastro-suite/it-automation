...
//
    ...
    class Db_Access_Core {
        ...
        function Filter1Tbl_add_selectbox($int_seq_no){
            ...
            $terraform_pattern_dir = "2100080004";
            require_once($g['root_dir_path'] . "/webconfs/systems/{$terraform_pattern_dir}_loadTable.php");
            $objTable1 = loadTable($terraform_pattern_dir,$aryTmpVariant,$aryTmpSetting);
