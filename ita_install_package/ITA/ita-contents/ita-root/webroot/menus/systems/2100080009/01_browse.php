...
//
    ...
    $objTable1 = loadTable($terraform_pattern_dir,$aryTmpVariant1,$aryTmpSetting1);
...
EOD;
    ...
    //$strPageInfo = "作業パターンを単体実行できます。<br>・即時実行<br>・予約実行<br>が可能です。<br>実行時には作業パターンとオペレーションIDを選択して下さい。";
