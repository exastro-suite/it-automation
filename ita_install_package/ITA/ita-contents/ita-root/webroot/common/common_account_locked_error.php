...
//
    ...
    if( 0 < strlen($ADMIN_OFFICE) ){
        $strMailTag = $objMTS->getSomeMessage("ITAWDCH-MNU-1160003",$ADMIN_OFFICE);
    }
    
    // アカウントロック中のアカウントへのアクセス
...
<head>
    ...
    <title>{$objMTS->getSomeMessage("ITAWDCH-MNU-1160001")}</title>
</head>
<body>
    <br>
    {$objMTS->getSomeMessage("ITAWDCH-MNU-1160002")}<br>
    {$strMailTag}<br>
</body>
</html>
EOD;
