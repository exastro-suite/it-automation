...
//
    ...
    if( 0 < strlen($ADMIN_OFFICE) ){
        $strMailTag = $objMTS->getSomeMessage("ITAWDCH-MNU-1130003",$ADMIN_OFFICE);
    }

    // ホワイトリスト有効時の、リスト外IPからのアクセス
...
<head>
    ...
    <title>{$objMTS->getSomeMessage("ITAWDCH-MNU-1130001")}</title>
</head>
<body>
    <br>
    {$objMTS->getSomeMessage("ITAWDCH-MNU-1130002")}<br>
    {$strMailTag}<br>
</body>
</html>
EOD;
