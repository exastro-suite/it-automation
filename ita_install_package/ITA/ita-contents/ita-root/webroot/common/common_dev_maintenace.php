...
//
    ...
    if( 0 < strlen($ADMIN_OFFICE) ){
        $strMailTag = $objMTS->getSomeMessage("ITAWDCH-MNU-1150003",$ADMIN_OFFICE);
    }
...
<head>
    ...
    <title>{$objMTS->getSomeMessage("ITAWDCH-MNU-1150001")}</title>
</head>
<body>
    <br>
    {$objMTS->getSomeMessage("ITAWDCH-MNU-1150002")}<br>
    {$strMailTag}<br>
</body>
</html>
EOD;
