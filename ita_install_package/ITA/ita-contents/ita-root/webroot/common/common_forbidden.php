...
if (0 < strlen($ADMIN_OFFICE)) {
    $strMailTag = $objMTS->getSomeMessage("ITAWDCH-MNU-4030003",$ADMIN_OFFICE);
}
...
<body>
    <br>
    <?= $objMTS->getSomeMessage("ITAWDCH-MNU-4030002") ?><br>
    <?= $strMailTag ?><br>
    <a href="/"><?= $objMTS->getSomeMessage("ITAWDCH-MNU-4030005") ?></a><br>
</body>
</html>
