...
// <<<<<<<<<<pioneer/legacy差分箇所>>>>>>>>>>
    ...
    //----変数名テーブル関連
// <<<<<<<<<<pioneer/legacy差分箇所>>>>>>>>>>
    $strCurTableAnsVarsTable = "B_ANSIBLE_PNS_VARS_MASTER";
    $strJnlTableAnsVarsTable = "B_ANSIBLE_PNS_VARS_MASTER_JNL";
    $strSeqOfCurTableAnsVars = "B_ANSIBLE_PNS_VARS_MASTER_RIC";
...
// <<<<<<<<<<pioneer/legacy差分箇所>>>>>>>>>>
    ...
    //----作業パターン変数名紐付テーブル関連
// <<<<<<<<<<pioneer/legacy差分箇所>>>>>>>>>>
    $strCurTableAnsPatternVarsLink = "B_ANS_PNS_PTN_VARS_LINK";
...
// <<<<<<<<<<pioneer/legacy差分箇所>>>>>>>>>>
        ...
        $vg_playbook_contents_dir = $vg_pioneer_playbook_contents_dir;
// <<<<<<<<<<pioneer/legacy差分箇所>>>>>>>>>>
...
// <<<<<<<<<<pioneer/legacy差分箇所>>>>>>>>>>
        $strTableCurAnsMatter    = "B_ANSIBLE_PNS_DIALOG";
        $strColumnIdOfMatterId   = "DIALOG_MATTER_ID";
        $strColumnIdOfMatterFile = "DIALOG_MATTER_FILE";
...
// <<<<<<<<<<pioneer/legacy差分箇所>>>>>>>>>>
        ...
        ////////////////////////////////////////////////////////////////
        $sqlUtnBody = "SELECT                                         "
                     ."  TBL_1.PATTERN_ID          PATTERN_ID,        "
                     ."  TBL_2.DIALOG_MATTER_ID    MATTER_ID          "
                     ."FROM                                           "
                     ."  (                                            "
                     ."    SELECT                                     "
                     ."      PATTERN_ID,                              "
