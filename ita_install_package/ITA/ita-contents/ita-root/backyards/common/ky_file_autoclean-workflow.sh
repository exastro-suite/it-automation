...
##
##  【概要】
##      ky_file_autoclean-workflow.php
##      の起動スクリプト
##
######################################################################
...
# 定数
#----------------------------------------------------#
PROG='ky_file_autoclean-workflow'
PROCESS=${ROOT_DIR_PATH}'/backyards/common/ky_file_autoclean-workflow.sh'
PHP_PROCEDURE=${ROOT_DIR_PATH}'/backyards/common/ky_file_autoclean-workflow.php'
