...
try{
    ...
    $bindParam = array('ROW_ID'=>2100170006);
    ...
    $bindParam = array('LOADED_FLG'=>'1', 'ROW_ID'=>2100170006, 'LAST_UPDATE_TIMESTAMP'=>$objDBCA->getQueryTime(), 'LAST_UPDATE_TIMESTAMP2'=>$procLastUpdateTimeStamp);
    $objQuery->sqlBind($bindParam);
