...
SELECT
        ...
        CHILD_MEMBER_VARS_VALUE,
          CASE
            WHEN
            NOT EXISTS(
              SELECT PARENT_MEMBER_VARS_ID FROM B_TERRAFORM_VAR_MEMBER WHERE PARENT_MEMBER_VARS_ID = TAB_A.CHILD_MEMBER_VARS_ID OR TAB_A.CHILD_VARS_TYPE_ID = 7
            )
            AND
            NOT EXISTS(
              SELECT CHILD_MEMBER_VARS_ID FROM B_TERRAFORM_VAR_MEMBER AS TAB_B WHERE PARENT_VARS_ID = TAB_A.PARENT_VARS_ID AND TAB_B.CHILD_VARS_TYPE_ID = 7
            )
            THEN 1
            ELSE 0
...
--Module変数紐付管理 View
CREATE VIEW D_TERRAFORM_MODULE_VARS_LINK AS
SELECT
TAB_A.MODULE_VARS_LINK_ID,
TAB_A.MODULE_MATTER_ID,
TAB_A.VARS_NAME,
TAB_A.VARS_DESCRIPTION,
TAB_A.TYPE_ID,               -- タイプID
TAB_A.VARS_VALUE,            -- デフォルト値
CASE
WHEN
NOT EXISTS(
  SELECT
    PARENT_MEMBER_VARS_ID
  FROM
    B_TERRAFORM_VAR_MEMBER
  LEFT OUTER JOIN
    B_TERRAFORM_TYPES_MASTER
  ON
    B_TERRAFORM_VAR_MEMBER.CHILD_VARS_TYPE_ID = B_TERRAFORM_TYPES_MASTER.TYPE_ID
  WHERE
    PARENT_VARS_ID = TAB_A.MODULE_VARS_LINK_ID
  AND
    B_TERRAFORM_VAR_MEMBER.CHILD_VARS_TYPE_ID = 7
  AND
    B_TERRAFORM_VAR_MEMBER.DISUSE_FLAG = 0
  OR
    TAB_B.MEMBER_VARS_FLAG = 0
)
THEN 1
ELSE 0
END AS MEMBER_VARS_ASSIGN_FLAG,
TAB_A.DISP_SEQ,              -- 表示順序
TAB_A.ACCESS_AUTH,
TAB_A.NOTE,                  -- 備考
TAB_A.DISUSE_FLAG,           -- 廃止フラグ
TAB_A.LAST_UPDATE_TIMESTAMP, -- 最終更新日時
TAB_A.LAST_UPDATE_USER       -- 最終更新ユーザ
FROM B_TERRAFORM_MODULE_VARS_LINK  AS TAB_A
LEFT JOIN B_TERRAFORM_TYPES_MASTER AS TAB_B
ON TAB_A.TYPE_ID = TAB_B.TYPE_ID;

--Module変数紐付管理履歴 View
CREATE VIEW D_TERRAFORM_MODULE_VARS_LINK_JNL AS
SELECT
TAB_A.JOURNAL_SEQ_NO,
TAB_A.JOURNAL_REG_DATETIME,
TAB_A.JOURNAL_ACTION_CLASS,
...
TAB_A.LAST_UPDATE_TIMESTAMP, -- 最終更新日時
TAB_A.LAST_UPDATE_USER       -- 最終更新ユーザ
FROM B_TERRAFORM_MODULE_VARS_LINK_JNL  AS TAB_A
LEFT JOIN B_TERRAFORM_TYPES_MASTER     AS TAB_B
ON TAB_A.TYPE_ID = TAB_B.TYPE_ID;
...
INSERT INTO A_MENU_LIST (MENU_ID,MENU_GROUP_ID,MENU_NAME,WEB_PRINT_LIMIT,WEB_PRINT_CONFIRM,XLS_PRINT_LIMIT,LOGIN_NECESSITY,SERVICE_STATUS,AUTOFILTER_FLG,INITIAL_FILTER_FLG,DISP_SEQ,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES(2100080018,2100080001,'Movement variable association list',NULL,NULL,NULL,1,0,1,2,210,NULL,'0',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
INSERT INTO A_MENU_LIST_JNL (JOURNAL_SEQ_NO,JOURNAL_REG_DATETIME,JOURNAL_ACTION_CLASS,MENU_ID,MENU_GROUP_ID,MENU_NAME,WEB_PRINT_LIMIT,WEB_PRINT_CONFIRM,XLS_PRINT_LIMIT,LOGIN_NECESSITY,SERVICE_STATUS,AUTOFILTER_FLG,INITIAL_FILTER_FLG,DISP_SEQ,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES(-80018,STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),'INSERT',2100080018,2100080001,'Movement variable association list',NULL,NULL,NULL,1,0,1,2,210,NULL,'0',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
...
INSERT INTO A_ACCOUNT_LIST (USER_ID,USERNAME,PASSWORD,USERNAME_JP,MAIL_ADDRESS,PW_EXPIRATION,DEACTIVATE_PW_CHANGE,AUTH_TYPE,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES(-101802,'t1e','5ebbc37e034d6874a2af59eb04beaa52','Terraform execution procedure',NULL,NULL,NULL,NULL,'Terraform execution procedure','H',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
INSERT INTO A_ACCOUNT_LIST_JNL (JOURNAL_SEQ_NO,JOURNAL_REG_DATETIME,JOURNAL_ACTION_CLASS,USER_ID,USERNAME,PASSWORD,USERNAME_JP,MAIL_ADDRESS,PW_EXPIRATION,DEACTIVATE_PW_CHANGE,AUTH_TYPE,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES(-101802,STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),'INSERT',-101802,'t1e','5ebbc37e034d6874a2af59eb04beaa52','Terraform execution procedure',NULL,NULL,NULL,NULL,'Terraform execution procedure','H',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
INSERT INTO A_ACCOUNT_LIST (USER_ID,USERNAME,PASSWORD,USERNAME_JP,MAIL_ADDRESS,PW_EXPIRATION,DEACTIVATE_PW_CHANGE,AUTH_TYPE,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES(-101803,'t1a','5ebbc37e034d6874a2af59eb04beaa52','Terraform variable update procedure',NULL,NULL,NULL,NULL,'Terraform variable update procedure','H',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
...
INSERT INTO A_ACCOUNT_LIST (USER_ID,USERNAME,PASSWORD,USERNAME_JP,MAIL_ADDRESS,PW_EXPIRATION,DEACTIVATE_PW_CHANGE,AUTH_TYPE,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES(-101804,'t1b','5ebbc37e034d6874a2af59eb04beaa52','Terraform substitution value auto-registration setting procedure',NULL,NULL,NULL,NULL,'Terraform substitution value auto-registration setting procedure','H',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
INSERT INTO A_ACCOUNT_LIST_JNL (JOURNAL_SEQ_NO,JOURNAL_REG_DATETIME,JOURNAL_ACTION_CLASS,USER_ID,USERNAME,PASSWORD,USERNAME_JP,MAIL_ADDRESS,PW_EXPIRATION,DEACTIVATE_PW_CHANGE,AUTH_TYPE,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES(-101804,STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),'INSERT',-101804,'t1b','5ebbc37e034d6874a2af59eb04beaa52','Terraform substitution value auto-registration setting procedure',NULL,NULL,NULL,NULL,'Terraform substitution value auto-registration setting procedure','H',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
...
INSERT INTO A_ROLE_MENU_LINK_LIST (LINK_ID,ROLE_ID,MENU_ID,PRIVILEGE,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES(2100080018,1,2100080018,2,'System Administrator','1',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
INSERT INTO A_ROLE_MENU_LINK_LIST_JNL (JOURNAL_SEQ_NO,JOURNAL_REG_DATETIME,JOURNAL_ACTION_CLASS,LINK_ID,ROLE_ID,MENU_ID,PRIVILEGE,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES(-180018,STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),'INSERT',2100080018,1,2100080018,2,'System Administrator','1',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
...
INSERT INTO B_TERRAFORM_RUN_MODE (RUN_MODE_ID,RUN_MODE_NAME,DISP_SEQ,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES(3,'Delete resource',1,NULL,'0',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
...
INSERT INTO B_TERRAFORM_TYPES_MASTER (TYPE_ID,TYPE_NAME,MEMBER_VARS_FLAG,ASSIGN_SEQ_FLAG,ENCODE_FLAG,DISP_SEQ,NOTE,DISUSE_FLAG,LAST_UPDATE_TIMESTAMP,LAST_UPDATE_USER) VALUES('19','object(map)',0,0,1,NULL,NULL,'0',STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f'),1);
