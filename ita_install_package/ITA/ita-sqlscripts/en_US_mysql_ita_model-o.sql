...
FROM
  ...
  LEFT JOIN B_TERRAFORM_PATTERN_LINK TAB_B ON ( TAB_A.PATTERN_ID = TAB_B.PATTERN_ID AND TAB_A.MODULE_MATTER_ID = TAB_B.MODULE_MATTER_ID)
;
...
FROM
  D_TERRAFORM_MODULE_PTN_VARS_LINK_2 TAB_A
  LEFT JOIN B_TERRAFORM_PATTERN_LINK_JNL TAB_B ON ( TAB_A.PATTERN_ID = TAB_B.PATTERN_ID AND TAB_A.MODULE_MATTER_ID = TAB_B.MODULE_MATTER_ID)
;
