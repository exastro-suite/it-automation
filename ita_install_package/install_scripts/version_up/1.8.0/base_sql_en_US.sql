...
UPDATE A_SYSTEM_CONFIG_LIST SET NOTE=CONCAT('Validity period of password (days)','\n','Positive number (integer only): Same as above, Password change at first login is valid','\n','Zero or less: Permanently valid (can use)') WHERE ITEM_ID=2100000007;
UPDATE A_SYSTEM_CONFIG_LIST_JNL SET NOTE=CONCAT('Validity period of password (days)','\n','Positive number (integer only): Same as above, Password change at first login is valid','\n','Zero or less: Permanently valid (can use)') WHERE ITEM_ID=2100000007;
