...
UPDATE A_MENU_LIST SET  MENU_NAME='Ansible Automation Controller ホスト一覧' WHERE MENU_ID=2100040708;
UPDATE A_MENU_LIST_JNL SET  MENU_NAME='Ansible Automation Controller ホスト一覧' WHERE MENU_ID=2100040708;


UPDATE A_ACCOUNT_LIST SET USERNAME_JP='Ansible Automation Controllerデータ同期プロシージャ' WHERE USER_ID=-121006;
UPDATE A_ACCOUNT_LIST_JNL SET USERNAME_JP='Ansible Automation Controllerデータ同期プロシージャ' WHERE USER_ID=-121006;
