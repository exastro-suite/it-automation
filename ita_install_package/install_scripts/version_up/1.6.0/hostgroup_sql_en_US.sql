...
UPDATE A_SEQUENCE SET MENU_ID=2100170001, DISP_SEQ=2100710002, NOTE='for the history table.', LAST_UPDATE_TIMESTAMP=STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f') WHERE NAME='F_HOSTGROUP_LIST_JSQ';
...
UPDATE A_SEQUENCE SET MENU_ID=2100170002, DISP_SEQ=2100710004, NOTE='for the history table.', LAST_UPDATE_TIMESTAMP=STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f') WHERE NAME='F_HOST_LINK_LIST_JSQ';
...
UPDATE A_SEQUENCE SET MENU_ID=2100170003, DISP_SEQ=2100710006, NOTE='for the history table.', LAST_UPDATE_TIMESTAMP=STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f') WHERE NAME='F_HOST_LINK_JSQ';
...
UPDATE A_SEQUENCE SET MENU_ID=2100170004, DISP_SEQ=2100710008, NOTE='for the history table.', LAST_UPDATE_TIMESTAMP=STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f') WHERE NAME='F_SPLIT_TARGET_JSQ';
