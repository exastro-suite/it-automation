...
UPDATE A_SEQUENCE SET MENU_ID=2100170005, DISP_SEQ=2100720002, NOTE='for the history table.', LAST_UPDATE_TIMESTAMP=STR_TO_DATE('2015/04/01 10:00:00.000000','%Y/%m/%d %H:%i:%s.%f') WHERE NAME='F_HOSTGROUP_VAR_JSQ';
