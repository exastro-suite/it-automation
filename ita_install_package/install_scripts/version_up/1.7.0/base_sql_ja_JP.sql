...
UPDATE A_MENU_LIST SET NOTE='廃止不可' WHERE MENU_ID IN (2100000214,2100000215,2100000311,2100000221,2100000222,2100000299,2100000231,2100000232,2100000232,2100000216);
UPDATE A_MENU_LIST_JNL SET NOTE='廃止不可' WHERE MENU_ID IN (2100000214,2100000215,2100000311,2100000221,2100000222,2100000299,2100000231,2100000232,2100000232,2100000216);

UPDATE A_MENU_LIST SET MENU_NAME='エクスポート・インポート管理', NOTE='' WHERE MENU_ID IN (2100000213);
UPDATE A_MENU_LIST_JNL SET MENU_NAME='エクスポート・インポート管理', NOTE='' WHERE MENU_ID IN (2100000213);

UPDATE A_MENU_LIST SET MENU_NAME='オペレーション一覧', NOTE='' WHERE MENU_ID IN (2100000304);
UPDATE A_MENU_LIST_JNL SET MENU_NAME='オペレーション一覧', NOTE='' WHERE MENU_ID IN (2100000304);
...
UPDATE B_LOGIN_AUTH_TYPE SET LOGIN_AUTH_TYPE_NAME='鍵認証(パスフレーズなし) ', DISP_SEQ=2 WHERE LOGIN_AUTH_TYPE_ID=1;
UPDATE B_LOGIN_AUTH_TYPE_JNL SET LOGIN_AUTH_TYPE_NAME='鍵認証(パスフレーズなし) ', DISP_SEQ=2 WHERE LOGIN_AUTH_TYPE_ID=1;
...
UPDATE B_DP_MODE SET DP_MODE='環境移行' WHERE ROW_ID=1;
UPDATE B_DP_MODE SET DP_MODE='時刻指定' WHERE ROW_ID=2;
