...
UPDATE A_MENU_LIST SET NOTE='' WHERE MENU_ID IN (2100020103,2100020106,2100020107,2100020108,2100020109,2100020110,2100020111,2100020112,2100020113,2100020203,2100020204,2100000302,2100020205,2100020207,2100020208,2100020209,2100020210,2100020211,2100020212,2100020213,2100020303,2100020304,2100020305,2100020306,2100020308,2100020309,2100020310,2100020311,2100020312,2100020313,2100020314,2100020315,2100040702,2100040706,2100040703,2100040704,2100020115,2100020214,2100020316,2100020317,2100020318,2100020320,2100020322,2100040707,2100040708);
...
UPDATE A_MENU_LIST SET MENU_NAME='Playbook素材集', NOTE='' WHERE MENU_ID IN (2100020104);
UPDATE A_MENU_LIST_JNL SET MENU_NAME='Playbook素材集', NOTE='' WHERE MENU_ID IN (2100020104);

UPDATE A_MENU_LIST SET MENU_NAME='Movement-Playbook紐付', NOTE='' WHERE MENU_ID IN (2100020105);
UPDATE A_MENU_LIST_JNL SET MENU_NAME='Movement-Playbook紐付', NOTE='' WHERE MENU_ID IN (2100020105);

UPDATE A_MENU_LIST SET MENU_NAME='Movement-対話種別紐付', NOTE='' WHERE MENU_ID IN (2100020206);
UPDATE A_MENU_LIST_JNL SET MENU_NAME='Movement-対話種別紐付', NOTE='' WHERE MENU_ID IN (2100020206);

UPDATE A_MENU_LIST SET MENU_NAME='Movement-ロール紐付', NOTE='' WHERE MENU_ID IN (2100020307);
UPDATE A_MENU_LIST_JNL SET MENU_NAME='Movement-ロール紐付', NOTE='' WHERE MENU_ID IN (2100020307);

UPDATE A_MENU_LIST SET MENU_NAME='変数ネスト管理', NOTE='' WHERE MENU_ID IN (2100020319);
UPDATE A_MENU_LIST_JNL SET MENU_NAME='変数ネスト管理', NOTE='' WHERE MENU_ID IN (2100020319);
