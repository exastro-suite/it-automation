...
UPDATE A_MENU_LIST SET MENU_NAME='Movement-Module紐付', NOTE='' WHERE MENU_ID IN (2100080007);
UPDATE A_MENU_LIST_JNL SET MENU_NAME='Movement-Module紐付', NOTE='' WHERE MENU_ID IN (2100080007);

UPDATE A_MENU_LIST SET MENU_NAME='連携先Terraform管理', NOTE='' WHERE MENU_ID IN (2100080017);
UPDATE A_MENU_LIST_JNL SET MENU_NAME='連携先Terraform管理', NOTE='' WHERE MENU_ID IN (2100080017);
